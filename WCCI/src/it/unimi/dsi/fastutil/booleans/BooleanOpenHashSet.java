...
public class BooleanOpenHashSet extends AbstractBooleanSet implements java.io.Serializable, Cloneable, Hash {
 ...
 public BooleanOpenHashSet( final int n, final float f ) {
 ...
 public BooleanOpenHashSet( final int n ) {
 ...
 protected final int findInsertionPoint( final boolean k ) {
  ...
  final int k2i = (k ? 1231 : 1237) & 0x7FFFFFFF;
 ...
 protected final int findKey( final boolean k ) {
  final boolean key[] = this.key;
  final byte state[] = this.state;
  final int n = key.length;
 ...
 private class SetIterator extends AbstractBooleanIterator {
  ...
  {
   final byte state[] = BooleanOpenHashSet.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < BooleanOpenHashSet.this.state.length;
  }
 ...
 protected void rehash( final int newP ) {
  ...
  final boolean key[] = this.key, newKey[] = new boolean[ newN ];
 ...
 private void writeObject(java.io.ObjectOutputStream s) throws java.io.IOException {
  ...
  while( j-- != 0 ) s.writeBoolean( i.nextBoolean() );
 }
