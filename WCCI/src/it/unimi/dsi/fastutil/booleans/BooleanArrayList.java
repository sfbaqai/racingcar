...
public final class BooleanArrayList extends AbstractBooleanList implements RandomAccess, Cloneable, java.io.Serializable {
 ...
 public static final BooleanArrayList wrap( final boolean a[], final int length ) {
 ...
 public static final BooleanArrayList wrap( final boolean a[] ) {
 ...
 public final int indexOf( final boolean k ) {
 ...
 public final int lastIndexOf( final boolean k ) {
...
//*/
 ...
 public final void getElements( final int from, final boolean[] a, final int offset, final int length ) {
 ...
 public final boolean[] toBooleanArray( boolean a[] ) {
  if ( a == null || a.length < size ) a = new boolean[ size ];
  System.arraycopy( this.a, 0, a, 0, size );
  return a;
 }

 public final boolean addAll( int index, final BooleanCollection c ) {
 ...
 public final boolean addAll( final int index, final BooleanList l ) {
  if (index>=a.length) ensureIndex( index );
  final int n = l.size();
  if ( n == 0 ) return false;
  if (size+n>a.length) grow( size + n );
 ...
 public final BooleanListIterator listIterator( final int index ) {
  if (index>=a.length) ensureIndex( index );
 ...
 public final Object clone() {
  ...
  return c;
	 ...
	 */
 public final boolean equals( final BooleanArrayList l ) {
  ...
  return true;
     ...
     */
 @SuppressWarnings("unchecked")
 public final int compareTo( final BooleanArrayList l ) {
