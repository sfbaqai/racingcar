...
public final class BooleanArrays {
 ...
 /** Ensures that an array can contain the given number of entries.
	 ...
	 */
 public static final boolean[] ensureCapacity( final boolean[] array, final int length ) {
 ...
 /** Ensures that an array can contain the given number of entries, preserving just a part of the array.
	 ...
	 * entries are the same as those of <code>array</code>.
	 */
 public static final boolean[] ensureCapacity( final boolean[] array, final int length, final int preserve ) {
  if ( length > array.length ) {
   final boolean t[] =
 ...
 public static final boolean[] grow( final boolean[] array, final int length ) {
  if ( length > array.length ) {
 ...
 public static final boolean[] grow( final boolean[] array, final int length, final int preserve ) {
 ...
 public static final boolean[] trim( final boolean[] array, final int length ) {
 ...
 public static final boolean[] setLength( final boolean[] array, final int length ) {
  if ( length == array.length ) return array;
 ...
 public static final boolean[] copy( final boolean[] array, final int offset, final int length ) {
 ...
 public static final boolean[] copy( final boolean[] array ) {
  return array.clone();
 }
 ...
 public static final void fill( final boolean[] array, final boolean value ) {
  int i = array.length;
 ...
 public static final void fill( final boolean[] array, final int from, int to, final boolean value ) {
 ...
 public static final boolean equals( final boolean[] a1, final boolean a2[] ) {
  int i = a1.length;
 ...
 /** Ensures that a range given by its first (inclusive) and last (exclusive) elements fits an array.
	 ...
	 */
 public static final void ensureFromTo( final boolean[] a, final int from, final int to ) {
 ...
 /** Ensures that a range given by an offset and a length fits an array.
	 ...
	 */
 public static final void ensureOffsetLength( final boolean[] a, final int offset, final int length ) {
