...
public class FloatHeapIndirectDoublePriorityQueue extends FloatHeapIndirectPriorityQueue implements FloatIndirectDoublePriorityQueue {
 ...
 /** Creates a new empty queue with a given capacity.
	 ...
	 */
 public FloatHeapIndirectDoublePriorityQueue( float[] refArray, int capacity, FloatComparator c, FloatComparator d ) {
  super( refArray, capacity, c );
  secondaryQueue = new FloatHeapIndirectPriorityQueue ( refArray, capacity, d );
 }
 ...
 public FloatHeapIndirectDoublePriorityQueue( float[] refArray, int capacity, FloatComparator c ) {
  super( refArray, capacity, c );
  secondaryQueue = new FloatHeapIndirectPriorityQueue ( refArray, capacity, c == null ? FloatComparators.OPPOSITE_COMPARATOR : FloatComparators.oppositeComparator( c ) );
 }
 ...
 /** Creates a new empty queue with a given capacity and natural order as primary comparator.
	 ...
	 * @param capacity the initial capacity of this queue.
	 */
 public FloatHeapIndirectDoublePriorityQueue( float[] refArray, int capacity ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public FloatHeapIndirectDoublePriorityQueue( float[] refArray, FloatComparator c, FloatComparator d ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public FloatHeapIndirectDoublePriorityQueue( float[] refArray, FloatComparator c ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array and natural order as primary comparator.
	 ...
	 * @param refArray the reference array.
	 */
 public FloatHeapIndirectDoublePriorityQueue( float[] refArray ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public FloatHeapIndirectDoublePriorityQueue( final float[] refArray, final int[] a, int size, final FloatComparator c, final FloatComparator d ) {
  super( refArray, a, size, c );
  this.secondaryQueue = new FloatHeapIndirectPriorityQueue ( refArray, a.clone(), size, d );
 }
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public FloatHeapIndirectDoublePriorityQueue( final float[] refArray, final int[] a, final FloatComparator c, final FloatComparator d ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 */
 @SuppressWarnings("unchecked")
 public FloatHeapIndirectDoublePriorityQueue( final float[] refArray, final int[] a, int size, final FloatComparator c ) {
  this( refArray, a, size, c, c == null ? FloatComparators.OPPOSITE_COMPARATOR : FloatComparators.oppositeComparator( c ) );
 }
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public FloatHeapIndirectDoublePriorityQueue( final float[] refArray, final int[] a, final FloatComparator c ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public FloatHeapIndirectDoublePriorityQueue( final float[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public FloatHeapIndirectDoublePriorityQueue( final float[] refArray, final int[] a ) {
 ...
 /** Returns the secondary comparator of this queue.
	 ...
	 * @see #secondaryFirst()
	 */
 public FloatComparator secondaryComparator() { return secondaryQueue.comparator(); }
}
