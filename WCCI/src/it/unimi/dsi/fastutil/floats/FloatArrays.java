...
public final class FloatArrays {
 ...
 /** Ensures that an array can contain the given number of entries.
	 ...
	 */
 public static final float[] ensureCapacity( final float[] array, final int length ) {
 ...
 /** Ensures that an array can contain the given number of entries, preserving just a part of the array.
	 ...
	 * entries are the same as those of <code>array</code>.
	 */
 public static final float[] ensureCapacity( final float[] array, final int length, final int preserve ) {
  if ( length > array.length ) {
   final float t[] =
 ...
 public static final float[] grow( final float[] array, final int length ) {
  if ( length > array.length ) {
 ...
 public static final float[] grow( final float[] array, final int length, final int preserve ) {
 ...
 public static final float[] trim( final float[] array, final int length ) {
 ...
 public static final float[] setLength( final float[] array, final int length ) {
  if ( length == array.length ) return array;
 ...
 public static final float[] copy( final float[] array, final int offset, final int length ) {
 ...
 public static final void fill( final float[] array, final float value ) {
  int i = array.length;
 ...
 public static final void fill( final float[] array, final int from, int to, final float value ) {
 ...
 public static final boolean equals( final float[] a1, final float a2[] ) {
  int i = a1.length;
 ...
 /** Ensures that a range given by its first (inclusive) and last (exclusive) elements fits an array.
	 ...
	 */
 public static final void ensureFromTo( final float[] a, final int from, final int to ) {
 ...
 /** Ensures that a range given by an offset and a length fits an array.
	 ...
	 */
 public static final void ensureOffsetLength( final float[] a, final int offset, final int length ) {
