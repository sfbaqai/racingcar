...
public class FloatArrayIndirectDoublePriorityQueue extends FloatArrayIndirectPriorityQueue implements FloatIndirectDoublePriorityQueue {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public FloatArrayIndirectDoublePriorityQueue( final float[] refArray, final int[] a, int size, final FloatComparator c, final FloatComparator d ) {
  this( refArray, 0, c, d );
  this.array = a;
  this.size = size;
 }
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public FloatArrayIndirectDoublePriorityQueue( final float[] refArray, final int[] a, final FloatComparator c, final FloatComparator d ) {
 ...
 /** Wraps a given array in a queue using a given comparator and its opposite.
	 ...
	 */
 public FloatArrayIndirectDoublePriorityQueue( final float[] refArray, final int[] a, int size, final FloatComparator c ) {
  this( refArray, 0, c );
  this.array = a;
  this.size = size;
 }
 ...
 /** Wraps a given array in a queue using a given comparator and its opposite.
	 ...
	 * @param c the comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public FloatArrayIndirectDoublePriorityQueue( final float[] refArray, final int[] a, final FloatComparator c ) {
 ...
 /** Wraps a given array in a queue using the natural order and its opposite.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public FloatArrayIndirectDoublePriorityQueue( final float[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order and its opposite.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public FloatArrayIndirectDoublePriorityQueue( final float[] refArray, final int[] a ) {
 ...
 public int secondaryFront( int[] a ) {
  final float secondaryTop = refArray[ array[ findSecondaryFirst() ] ];
  int i = size, c = 0;
 ...
 /** Returns the secondary comparator of this queue.
	 ...
	 * @see #secondaryFirst()
	 */
 public FloatComparator secondaryComparator() { return secondaryComparator; }
}
