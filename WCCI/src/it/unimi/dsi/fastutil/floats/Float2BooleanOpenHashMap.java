...
public class Float2BooleanOpenHashMap extends AbstractFloat2BooleanMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2BooleanOpenHashMap( final int n, final float f ) {
 ...
 public Float2BooleanOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Float2BooleanOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Float2BooleanOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Float2BooleanMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Boolean> e = (Map.Entry<Float, Boolean>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2BooleanOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
