...
public class Float2ByteOpenHashMap extends AbstractFloat2ByteMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2ByteOpenHashMap( final int n, final float f ) {
 ...
 public Float2ByteOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Float2ByteOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Float2ByteOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Byte> e = (Map.Entry<Float, Byte>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2ByteOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
