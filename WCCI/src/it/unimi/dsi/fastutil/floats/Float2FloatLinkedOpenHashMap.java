...
public class Float2FloatLinkedOpenHashMap extends AbstractFloat2FloatSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2FloatLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Float2FloatLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final float from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Float2FloatLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Float2FloatMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Float> e = (Map.Entry<Float, Float>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2FloatLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
