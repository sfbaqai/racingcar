...
public class Float2ByteLinkedOpenHashMap extends AbstractFloat2ByteSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2ByteLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Float2ByteLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final float from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Float2ByteLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Float2ByteMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Byte> e = (Map.Entry<Float, Byte>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2ByteLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
