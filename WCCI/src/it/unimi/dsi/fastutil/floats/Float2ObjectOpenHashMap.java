...
public class Float2ObjectOpenHashMap <V> extends AbstractFloat2ObjectMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2ObjectOpenHashMap( final int n, final float f ) {
 ...
 public Float2ObjectOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Float2ObjectOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Float2ObjectOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Float2ObjectMap.Entry <V> > implements FastEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, V> e = (Map.Entry<Float, V>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2ObjectOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
