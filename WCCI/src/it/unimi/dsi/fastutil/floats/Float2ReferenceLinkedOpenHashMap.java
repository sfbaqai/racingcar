...
public class Float2ReferenceLinkedOpenHashMap <V> extends AbstractFloat2ReferenceSortedMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2ReferenceLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Float2ReferenceLinkedOpenHashMap( final int n ) {
 ...
 private final class MapEntry implements Float2ReferenceMap.Entry <V>, Map.Entry<Float, V> {
  ...
  public int hashCode() {
   return it.unimi.dsi.fastutil.HashCommon.float2int(key[ index ]) ^ (System.identityHashCode(value[ index ]));
  }
 ...
 private class MapIterator {
  ...
  MapIterator( final float from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Float2ReferenceLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Float2ReferenceMap.Entry <V> > implements FastSortedEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, V> e = (Map.Entry<Float, V>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2ReferenceLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
