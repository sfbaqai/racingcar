...
public class Float2DoubleLinkedOpenHashMap extends AbstractFloat2DoubleSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2DoubleLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Float2DoubleLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final float from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Float2DoubleLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Float2DoubleMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Double> e = (Map.Entry<Float, Double>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2DoubleLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
