...
public class Float2IntOpenHashMap extends AbstractFloat2IntMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2IntOpenHashMap( final int n, final float f ) {
 ...
 public Float2IntOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Float2IntOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Float2IntOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Float2IntMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Integer> e = (Map.Entry<Float, Integer>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2IntOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
