...
public class Float2DoubleOpenHashMap extends AbstractFloat2DoubleMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2DoubleOpenHashMap( final int n, final float f ) {
 ...
 public Float2DoubleOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Float2DoubleOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Float2DoubleOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Float2DoubleMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Double> e = (Map.Entry<Float, Double>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2DoubleOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
