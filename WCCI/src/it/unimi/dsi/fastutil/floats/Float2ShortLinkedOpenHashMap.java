...
public class Float2ShortLinkedOpenHashMap extends AbstractFloat2ShortSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2ShortLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Float2ShortLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final float from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Float2ShortLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Float2ShortMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Short> e = (Map.Entry<Float, Short>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2ShortLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
