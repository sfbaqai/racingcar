...
public class CharArrayIndirectDoublePriorityQueue extends CharArrayIndirectPriorityQueue implements CharIndirectDoublePriorityQueue {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public CharArrayIndirectDoublePriorityQueue( final char[] refArray, final int[] a, int size, final CharComparator c, final CharComparator d ) {
  this( refArray, 0, c, d );
  this.array = a;
  this.size = size;
 }
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public CharArrayIndirectDoublePriorityQueue( final char[] refArray, final int[] a, final CharComparator c, final CharComparator d ) {
 ...
 /** Wraps a given array in a queue using a given comparator and its opposite.
	 ...
	 */
 public CharArrayIndirectDoublePriorityQueue( final char[] refArray, final int[] a, int size, final CharComparator c ) {
  this( refArray, 0, c );
  this.array = a;
  this.size = size;
 }
 ...
 /** Wraps a given array in a queue using a given comparator and its opposite.
	 ...
	 * @param c the comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public CharArrayIndirectDoublePriorityQueue( final char[] refArray, final int[] a, final CharComparator c ) {
 ...
 /** Wraps a given array in a queue using the natural order and its opposite.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public CharArrayIndirectDoublePriorityQueue( final char[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order and its opposite.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public CharArrayIndirectDoublePriorityQueue( final char[] refArray, final int[] a ) {
 ...
 public int secondaryFront( int[] a ) {
  final char secondaryTop = refArray[ array[ findSecondaryFirst() ] ];
  int i = size, c = 0;
 ...
 /** Returns the secondary comparator of this queue.
	 ...
	 * @see #secondaryFirst()
	 */
 public CharComparator secondaryComparator() { return secondaryComparator; }
}
