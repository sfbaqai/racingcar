...
public final class CharArrays {
 ...
 /** Ensures that an array can contain the given number of entries.
	 ...
	 */
 public static final char[] ensureCapacity( final char[] array, final int length ) {
 ...
 /** Ensures that an array can contain the given number of entries, preserving just a part of the array.
	 ...
	 * entries are the same as those of <code>array</code>.
	 */
 public static final char[] ensureCapacity( final char[] array, final int length, final int preserve ) {
  if ( length > array.length ) {
   final char t[] =
 ...
 public static final char[] grow( final char[] array, final int length ) {
  if ( length > array.length ) {
 ...
 public static final char[] grow( final char[] array, final int length, final int preserve ) {
 ...
 public static final char[] trim( final char[] array, final int length ) {
 ...
 public static final char[] setLength( final char[] array, final int length ) {
  if ( length == array.length ) return array;
 ...
 public static final char[] copy( final char[] array, final int offset, final int length ) {
 ...
 public static final char[] copy( final char[] array ) {
  return array.clone();
 }
 ...
 public static final void fill( final char[] array, final char value ) {
  int i = array.length;
 ...
 public static final void fill( final char[] array, final int from, int to, final char value ) {
 ...
 public static final boolean equals( final char[] a1, final char a2[] ) {
  int i = a1.length;
 ...
 /** Ensures that a range given by its first (inclusive) and last (exclusive) elements fits an array.
	 ...
	 */
 public static final void ensureFromTo( final char[] a, final int from, final int to ) {
  if ( from < 0 ) throw new ArrayIndexOutOfBoundsException( "Start index (" + from + ") is negative" );
  if ( from > to ) throw new IllegalArgumentException( "Start index (" + from + ") is greater than end index (" + to + ")" );
 ...
 /** Ensures that a range given by an offset and a length fits an array.
	 ...
	 */
 public static final void ensureOffsetLength( final char[] a, final int offset, final int length ) {
  if ( offset < 0 ) throw new ArrayIndexOutOfBoundsException( "Offset (" + offset + ") is negative" );
  if ( length < 0 ) throw new IllegalArgumentException( "Length (" + length + ") is negative" );
 ...
 private static final class ArrayHashStrategy implements Hash.Strategy<char[]>, java.io.Serializable {
  ...
  public final int hashCode( final char[] o ) {
   return java.util.Arrays.hashCode( o );
  }

  public final boolean equals( final char[] a, final char[] b ) {
   int i = a.length;
