...
public abstract class AbstractCharList extends AbstractCharCollection implements CharList , CharStack {
 ...
 private final class MyIter extends AbstractCharListIterator {
    ...
    public final boolean hasNext() { return pos < AbstractCharList.this.size(); }
    public final boolean hasPrevious() { return pos > 0; }
    public final char nextChar() { if ( ! hasNext() ) throw new NoSuchElementException(); return AbstractCharList.this.getChar( last = pos++ ); }
    public final char previousChar() { if ( ! hasPrevious() ) throw new NoSuchElementException(); return AbstractCharList.this.getChar( last = --pos ); }
 ...
 public static class CharSubList extends AbstractCharList implements java.io.Serializable {
  ...
  private final class MyIter extends AbstractCharListIterator {
     ...
     public final boolean hasPrevious() { return pos > 0; }
     public final char nextChar() { if ( pos >= size() ) throw new NoSuchElementException(); return l.getChar( from + ( last = pos++ ) ); }
     public final char previousChar() { if ( pos <= 0 ) throw new NoSuchElementException(); return l.getChar( from + ( last = --pos ) ); }
     public final int nextIndex() { return pos; }
     public final int previousIndex() { return pos - 1; }
     public final void add( char k ) {
      if ( last == -1 ) throw new IllegalStateException();
  ...
  public final boolean addAll( final int index, final Collection<? extends Character> c ) {
   int sz = to - from;
   if ( index < 0 ) throw new IndexOutOfBoundsException( "Index (" + index + ") is negative" );
   if ( index > sz ) throw new IndexOutOfBoundsException( "Index (" + index + ") is greater than list size (" + ( sz ) + ")" );
   to += c.size();
  ...
  public final void addElements( int index, final char a[], int offset, int length ) {
   int sz = to - from;
     if ( index < 0 ) throw new IndexOutOfBoundsException( "Index (" + index + ") is negative" );
     if ( index >= sz ) throw new IndexOutOfBoundsException( "Index (" + index + ") is greater than or equal to list size (" + ( sz ) + ")" );
  ...
  public final CharList subList( final int from, final int to ) {
