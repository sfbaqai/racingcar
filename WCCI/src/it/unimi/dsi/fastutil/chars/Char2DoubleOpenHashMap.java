...
public class Char2DoubleOpenHashMap extends AbstractChar2DoubleMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Char2DoubleOpenHashMap( final int n, final float f ) {
 ...
 public Char2DoubleOpenHashMap( final int n ) {
 ...
 protected final int findInsertionPoint( final char k ) {
 ...
 protected final int findKey( final char k ) {
  final char key[] = this.key;
  final byte state[] = this.state;
  final int n = key.length;
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Char2DoubleOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Char2DoubleOpenHashMap.this.state.length;
  }
 ...
 public Double get(final Character ok) {
  final int i = findKey(((ok).charValue()));
 ...
 public Double remove( final Object ok ) {
  final int i = findKey( ((((Character)(ok)).charValue())) );
  if (i < 0) return (null);
 ...
 private final class MapEntrySet extends AbstractObjectSet<Char2DoubleMap.Entry > implements FastEntrySet {
  ...
  public boolean contains( final Object o ) {
   ...
   final int i = findKey( ((e.getKey()).charValue()) );
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Character, Double> e = (Map.Entry<Character, Double>)o;
   final int i = findKey( ((e.getKey()).charValue()) );
   if ( i >= 0 ) Char2DoubleOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
 ...
 protected void rehash( final int newP ) {
  ...
  final char key[] = this.key, newKey[] = new char[newN];
