...
public class IntHeapSesquiIndirectDoublePriorityQueue extends IntHeapSemiIndirectPriorityQueue implements IntIndirectDoublePriorityQueue {
 ...
 /** Creates a new empty queue with a given capacity.
	 ...
	 */
 public IntHeapSesquiIndirectDoublePriorityQueue( int[] refArray, int capacity, IntComparator c, IntComparator d ) {
  super( refArray, capacity, c );
  secondaryQueue = new IntHeapIndirectPriorityQueue ( refArray, capacity, d );
 }
 ...
 public IntHeapSesquiIndirectDoublePriorityQueue( int[] refArray, int capacity, IntComparator c ) {
  super( refArray, capacity, c );
  secondaryQueue = new IntHeapIndirectPriorityQueue ( refArray, capacity, c == null ? IntComparators.OPPOSITE_COMPARATOR : IntComparators.oppositeComparator( c ) );
 }
 ...
 /** Creates a new empty queue with a given capacity and natural order as primary comparator.
	 ...
	 * @param capacity the initial capacity of this queue.
	 */
 public IntHeapSesquiIndirectDoublePriorityQueue( int[] refArray, int capacity ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public IntHeapSesquiIndirectDoublePriorityQueue( int[] refArray, IntComparator c, IntComparator d ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public IntHeapSesquiIndirectDoublePriorityQueue( int[] refArray, IntComparator c ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array and natural order as primary comparator.
	 ...
	 * @param refArray the reference array.
	 */
 public IntHeapSesquiIndirectDoublePriorityQueue( int[] refArray ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public IntHeapSesquiIndirectDoublePriorityQueue( final int[] refArray, final int[] a, int size, final IntComparator c, final IntComparator d ) {
  super( refArray, a, size, c );
  this.secondaryQueue = new IntHeapIndirectPriorityQueue ( refArray, a.clone(), size, d );
 }
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public IntHeapSesquiIndirectDoublePriorityQueue( final int[] refArray, final int[] a, final IntComparator c, final IntComparator d ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 */
 @SuppressWarnings("unchecked")
 public IntHeapSesquiIndirectDoublePriorityQueue( final int[] refArray, final int[] a, int size, final IntComparator c ) {
  this( refArray, a, size, c, c == null ? IntComparators.OPPOSITE_COMPARATOR : IntComparators.oppositeComparator( c ) );
 }
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public IntHeapSesquiIndirectDoublePriorityQueue( final int[] refArray, final int[] a, final IntComparator c ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public IntHeapSesquiIndirectDoublePriorityQueue( final int[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public IntHeapSesquiIndirectDoublePriorityQueue( final int[] refArray, final int[] a ) {
 ...
 /** Returns the secondary comparator of this queue.
	 ...
	 * @see #secondaryFirst()
	 */
 public IntComparator secondaryComparator() { return secondaryQueue.comparator(); }
}
