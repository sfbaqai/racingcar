...
public final class IntArrays {
 ...
 /** Ensures that an array can contain the given number of entries.
	 ...
	 */
 public static final int[] ensureCapacity( final int[] array, final int length ) {
 ...
 /** Ensures that an array can contain the given number of entries, preserving just a part of the array.
	 ...
	 * entries are the same as those of <code>array</code>.
	 */
 public static final int[] ensureCapacity( final int[] array, final int length, final int preserve ) {
  if ( length > array.length ) {
   final int t[] =
 ...
 public static final int[] grow( final int[] array, final int length ) {
  if ( length > array.length ) {
 ...
 public static final int[] grow( final int[] array, final int length, final int preserve ) {
 ...
 public static final int[] trim( final int[] array, final int length ) {
 ...
 public static final int[] setLength( final int[] array, final int length ) {
  if ( length == array.length ) return array;
 ...
 public static final int[] copy( final int[] array, final int offset, final int length ) {
 ...
 public static final void fill( final int[] array, final int from, int to, final int value ) {
 ...
 public static final boolean equals( final int[] a1, final int a2[] ) {
  int i = a1.length;
 ...
 /** Ensures that a range given by its first (inclusive) and last (exclusive) elements fits an array.
	 ...
	 */
 public static final void ensureFromTo( final int[] a, final int from, final int to ) {
  if ( from < 0 ) throw new ArrayIndexOutOfBoundsException( "Start index (" + from + ") is negative" );
  if ( from > to ) throw new IllegalArgumentException( "Start index (" + from + ") is greater than end index (" + to + ")" );
 ...
 /** Ensures that a range given by an offset and a length fits an array.
	 ...
	 */
 public static final void ensureOffsetLength( final int[] a, final int offset, final int length ) {
  if ( offset < 0 ) throw new ArrayIndexOutOfBoundsException( "Offset (" + offset + ") is negative" );
  if ( length < 0 ) throw new IllegalArgumentException( "Length (" + length + ") is negative" );
 ...
 private static final class ArrayHashStrategy implements Hash.Strategy<int[]>, java.io.Serializable {
  ...
  public final int hashCode( final int[] o ) {
   return java.util.Arrays.hashCode( o );
  }

  public final boolean equals( final int[] a, final int[] b ) {
   int i = a.length;
