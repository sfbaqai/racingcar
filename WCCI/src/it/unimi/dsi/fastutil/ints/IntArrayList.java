...
public final class IntArrayList extends AbstractIntList implements RandomAccess, Cloneable, java.io.Serializable {
...
private final class MyIter extends AbstractIntListIterator {
    ...
    public final int nextInt() { if ( pos>=size ) throw new NoSuchElementException(); return a[ last = pos++ ]; }
    public final int previousInt() { if ( pos<=0 ) throw new NoSuchElementException(); return a[ last = --pos ]; }
 ...
 public static final IntArrayList wrap( final int a[], final int length ) {
 ...
 public static final IntArrayList wrap( final int a[] ) {
 ...
 public final int indexOf( final int k ) {
 ...
 public final int lastIndexOf( final int k ) {
...
/*#if #keys(reference)
 ...
 public final int[] toIntArray( int a[] ) {
  if ( a == null || a.length < size ) a = new int[ size ];
  System.arraycopy( this.a, 0, a, 0, size );
  return a;
 }

 public final boolean addAll( int index, final IntCollection c ) {
  if ( index < 0 ) throw new IndexOutOfBoundsException( "Index (" + index + ") is negative" );
    if ( index > size ) throw new IndexOutOfBoundsException( "Index (" + index + ") is greater than list size (" + ( size ) + ")" );
  int n = c.size();
  if ( n == 0 ) return false;
 ...
 public final IntListIterator listIterator( final int index ) {
  if ( index < 0 ) throw new IndexOutOfBoundsException( "Index (" + index + ") is negative" );
    if ( index > size ) throw new IndexOutOfBoundsException( "Index (" + index + ") is greater than list size (" + ( size ) + ")" );
 ...
 public final Object clone() {
  ...
  return c;
	 ...
	 */
 public final boolean equals( final IntArrayList l ) {
  ...
  return true;
     ...
     */
 @SuppressWarnings("unchecked")
 public final int compareTo( final IntArrayList l ) {
