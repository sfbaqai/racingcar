...
public class Int2ReferenceOpenHashMap <V> extends AbstractInt2ReferenceMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Int2ReferenceOpenHashMap( final int n, final float f ) {
 ...
 public Int2ReferenceOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Int2ReferenceOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Int2ReferenceOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Int2ReferenceMap.Entry <V> > implements FastEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Integer, V> e = (Map.Entry<Integer, V>)o;
   final int i = findKey( ((e.getKey()).intValue()) );
   if ( i >= 0 ) Int2ReferenceOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
