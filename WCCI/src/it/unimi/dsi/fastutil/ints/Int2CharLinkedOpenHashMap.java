...
public class Int2CharLinkedOpenHashMap extends AbstractInt2CharSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Int2CharLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Int2CharLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final int from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Int2CharLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Int2CharMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Integer, Character> e = (Map.Entry<Integer, Character>)o;
   final int i = findKey( ((e.getKey()).intValue()) );
   if ( i >= 0 ) Int2CharLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
