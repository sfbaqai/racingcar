...
public class Int2ReferenceLinkedOpenHashMap <V> extends AbstractInt2ReferenceSortedMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Int2ReferenceLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Int2ReferenceLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final int from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    prev = last;
    index = count;
   }
   else {
    if ( ! Int2ReferenceLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Int2ReferenceMap.Entry <V> > implements FastSortedEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Integer, V> e = (Map.Entry<Integer, V>)o;
   final int i = findKey( ((e.getKey()).intValue()) );
   if ( i >= 0 ) Int2ReferenceLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
