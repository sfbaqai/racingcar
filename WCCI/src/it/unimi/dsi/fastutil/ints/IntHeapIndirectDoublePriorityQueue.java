...
public class IntHeapIndirectDoublePriorityQueue extends IntHeapIndirectPriorityQueue implements IntIndirectDoublePriorityQueue {
 ...
 /** Creates a new empty queue with a given capacity.
	 ...
	 */
 public IntHeapIndirectDoublePriorityQueue( int[] refArray, int capacity, IntComparator c, IntComparator d ) {
 ...
 public IntHeapIndirectDoublePriorityQueue( int[] refArray, int capacity, IntComparator c ) {
  super( refArray, capacity, c );
 ...
 /** Creates a new empty queue with a given capacity and natural order as primary comparator.
	 ...
	 * @param capacity the initial capacity of this queue.
	 */
 public IntHeapIndirectDoublePriorityQueue( int[] refArray, int capacity ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public IntHeapIndirectDoublePriorityQueue( int[] refArray, IntComparator c, IntComparator d ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public IntHeapIndirectDoublePriorityQueue( int[] refArray, IntComparator c ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array and natural order as primary comparator.
	 ...
	 * @param refArray the reference array.
	 */
 public IntHeapIndirectDoublePriorityQueue( int[] refArray ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public IntHeapIndirectDoublePriorityQueue( final int[] refArray, final int[] a, int size, final IntComparator c, final IntComparator d ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public IntHeapIndirectDoublePriorityQueue( final int[] refArray, final int[] a, final IntComparator c, final IntComparator d ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 */
 @SuppressWarnings("unchecked")
 public IntHeapIndirectDoublePriorityQueue( final int[] refArray, final int[] a, int size, final IntComparator c ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public IntHeapIndirectDoublePriorityQueue( final int[] refArray, final int[] a, final IntComparator c ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public IntHeapIndirectDoublePriorityQueue( final int[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public IntHeapIndirectDoublePriorityQueue( final int[] refArray, final int[] a ) {
