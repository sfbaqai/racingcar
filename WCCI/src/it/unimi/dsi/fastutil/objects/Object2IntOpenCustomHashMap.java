...
public class Object2IntOpenCustomHashMap <K> extends AbstractObject2IntMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2IntOpenCustomHashMap( final int n, final float f, final Strategy <K> strategy ) {
 ...
 public Object2IntOpenCustomHashMap( final int n, final Strategy <K> strategy ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Object2IntOpenCustomHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Object2IntOpenCustomHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2IntMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Integer> e = (Map.Entry<K, Integer>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2IntOpenCustomHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
