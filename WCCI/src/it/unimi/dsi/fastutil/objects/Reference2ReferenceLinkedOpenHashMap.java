...
public class Reference2ReferenceLinkedOpenHashMap <K,V> extends AbstractReference2ReferenceSortedMap <K,V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Reference2ReferenceLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Reference2ReferenceLinkedOpenHashMap( final int n ) {
 ...
 protected final int findInsertionPoint( final K k ) {
  ...
  final int k2i = (System.identityHashCode(k)) & 0x7FFFFFFF;
 ...
 private final class MapEntry implements Reference2ReferenceMap.Entry <K,V>, Map.Entry<K, V> {
  ...
  public int hashCode() {
   return (System.identityHashCode(key[ index ])) ^ (System.identityHashCode(value[ index ]));
  }
 ...
 private class MapIterator {
  ...
  MapIterator( final K from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Reference2ReferenceLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ReferenceMap.Entry <K,V> > implements FastSortedEntrySet <K,V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, V> e = (Map.Entry<K, V>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Reference2ReferenceLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
 ...
 protected void rehash( final int newP ) {
  ...
  while(j-- != 0) {
   ...
   k = key[i];
   v = value[i];
   k2i = (System.identityHashCode(k)) & 0x7FFFFFFF;
 ...
 public int hashCode() {
  ...
  while( j-- != 0 ) {
   ...
   if ( this != value[ i ] )
    ...
    t ^= (System.identityHashCode(value[ i ]));
   h += t;
   i++;
  }
  return h;
