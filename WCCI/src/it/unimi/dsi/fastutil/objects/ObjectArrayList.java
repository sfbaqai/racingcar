...
public final class ObjectArrayList <K> extends AbstractObjectList <K> implements RandomAccess, Cloneable, java.io.Serializable {
 public static final long serialVersionUID = -7046029254386353131L;




private final class MyIter extends AbstractObjectListIterator <K> {
    int pos = 0, last = -1;
    private MyIter(){  };
    private MyIter(int index){ pos = index; };
    public final boolean hasNext() { return pos < size; }
    public final boolean hasPrevious() { return pos > 0; }
    public final K next() { if ( pos>=size ) throw new NoSuchElementException(); return a[ last = pos++ ]; }
    public final K previous() { if ( pos<=0 ) throw new NoSuchElementException(); return a[ last = --pos ]; }
 ...
 public static final <K> ObjectArrayList <K> wrap( final K a[], final int length ) {
 ...
 public static final <K> ObjectArrayList <K> wrap( final K a[] ) {
 ...
 public final void ensureCapacity( final int capacity ) {
  if ( capacity > a.length ) {
   if ( wrapped ) {
       a = ObjectArrays.ensureCapacity(a, capacity);
   } else {
 ...
 public final K get( final int index ) {
  if ( index >= size ) throw new IndexOutOfBoundsException( "Index (" + index + ") is greater than or equal to list size (" + size + ")" );
  return a[ index ];
 }

 public final int indexOf( final Object k ) {
 ...
 public final int lastIndexOf( final Object k ) {
 ...
 public final boolean rem( final Object k ) {
  int index = indexOf( k );
 ...
 public final void size( final int size ) {
  if ( size > a.length ) {
   if ( wrapped ) {
    a = ObjectArrays.ensureCapacity(a, size);
   } else {

     final Object t[] = new Object[ size ];
...
//*/
 ...
 public final void getElements( final int from, final Object[] a, final int offset, final int length ) {
...
/*#if #keys(reference)
 ...
 public final ObjectListIterator <K> listIterator( final int index ) {
  if ( index < 0 ) throw new IndexOutOfBoundsException( "Index (" + index + ") is negative" );
    if ( index > size ) throw new IndexOutOfBoundsException( "Index (" + index + ") is greater than list size (" + ( size ) + ")" );
 ...
 private final boolean valEquals( final K a, final K b ) {
  return a == null ? b == null : a.equals( b );
	 ...
	 */
 public final boolean equals( final ObjectArrayList <K> l ) {
  ...
  return true;
     ...
     */
 @SuppressWarnings("unchecked")
 public final int compareTo( final ObjectArrayList <K> l ) {
