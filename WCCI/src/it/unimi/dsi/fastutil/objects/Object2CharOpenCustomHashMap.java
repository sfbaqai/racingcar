...
public class Object2CharOpenCustomHashMap <K> extends AbstractObject2CharMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2CharOpenCustomHashMap( final int n, final float f, final Strategy <K> strategy ) {
 ...
 public Object2CharOpenCustomHashMap( final int n, final Strategy <K> strategy ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Object2CharOpenCustomHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Object2CharOpenCustomHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2CharMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Character> e = (Map.Entry<K, Character>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2CharOpenCustomHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
