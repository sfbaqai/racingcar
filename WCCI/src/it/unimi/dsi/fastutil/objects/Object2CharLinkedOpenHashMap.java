...
public class Object2CharLinkedOpenHashMap <K> extends AbstractObject2CharSortedMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2CharLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Object2CharLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final K from ) {
   if ( ( (key[ last ]) == null ? (from) == null : (key[ last ]).equals(from) ) ) {
    ...
    if ( ! Object2CharLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Object2CharMap.Entry <K> > implements FastSortedEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Character> e = (Map.Entry<K, Character>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2CharLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
