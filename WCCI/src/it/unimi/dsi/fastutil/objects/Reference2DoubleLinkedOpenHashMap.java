...
public class Reference2DoubleLinkedOpenHashMap <K> extends AbstractReference2DoubleSortedMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Reference2DoubleLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Reference2DoubleLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final K from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Reference2DoubleLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Reference2DoubleMap.Entry <K> > implements FastSortedEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Double> e = (Map.Entry<K, Double>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Reference2DoubleLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
