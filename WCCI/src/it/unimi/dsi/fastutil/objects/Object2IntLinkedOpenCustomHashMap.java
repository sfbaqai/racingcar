...
public class Object2IntLinkedOpenCustomHashMap <K> extends AbstractObject2IntSortedMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2IntLinkedOpenCustomHashMap( final int n, final float f, final Strategy <K> strategy ) {
 ...
 public Object2IntLinkedOpenCustomHashMap( final int n, final Strategy <K> strategy ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final K from ) {
   if ( ( strategy.equals( (key[ last ]), (from) ) ) ) {
    ...
    if ( ! Object2IntLinkedOpenCustomHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Object2IntMap.Entry <K> > implements FastSortedEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Integer> e = (Map.Entry<K, Integer>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2IntLinkedOpenCustomHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
