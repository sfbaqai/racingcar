...
public class Reference2DoubleOpenHashMap <K> extends AbstractReference2DoubleMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Reference2DoubleOpenHashMap( final int n, final float f ) {
 ...
 public Reference2DoubleOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Reference2DoubleOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Reference2DoubleOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Reference2DoubleMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Double> e = (Map.Entry<K, Double>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Reference2DoubleOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
