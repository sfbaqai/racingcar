...
public class Reference2ObjectLinkedOpenHashMap <K,V> extends AbstractReference2ObjectSortedMap <K,V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Reference2ObjectLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Reference2ObjectLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final K from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Reference2ObjectLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ObjectMap.Entry <K,V> > implements FastSortedEntrySet <K,V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, V> e = (Map.Entry<K, V>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Reference2ObjectLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
