...
public class ObjectHeapIndirectDoublePriorityQueue <K> extends ObjectHeapIndirectPriorityQueue <K> implements IndirectDoublePriorityQueue <K> {
 ...
 /** Creates a new empty queue with a given capacity.
	 ...
	 */
 public ObjectHeapIndirectDoublePriorityQueue( K[] refArray, int capacity, Comparator <? super K> c, Comparator <? super K> d ) {
 ...
 public ObjectHeapIndirectDoublePriorityQueue( K[] refArray, int capacity, Comparator <? super K> c ) {
  super( refArray, capacity, c );
 ...
 /** Creates a new empty queue with a given capacity and natural order as primary comparator.
	 ...
	 * @param capacity the initial capacity of this queue.
	 */
 public ObjectHeapIndirectDoublePriorityQueue( K[] refArray, int capacity ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public ObjectHeapIndirectDoublePriorityQueue( K[] refArray, Comparator <? super K> c, Comparator <? super K> d ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public ObjectHeapIndirectDoublePriorityQueue( K[] refArray, Comparator <? super K> c ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array and natural order as primary comparator.
	 ...
	 * @param refArray the reference array.
	 */
 public ObjectHeapIndirectDoublePriorityQueue( K[] refArray ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public ObjectHeapIndirectDoublePriorityQueue( final K[] refArray, final int[] a, int size, final Comparator <? super K> c, final Comparator <? super K> d ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public ObjectHeapIndirectDoublePriorityQueue( final K[] refArray, final int[] a, final Comparator <? super K> c, final Comparator <? super K> d ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 */
 @SuppressWarnings("unchecked")
 public ObjectHeapIndirectDoublePriorityQueue( final K[] refArray, final int[] a, int size, final Comparator <? super K> c ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public ObjectHeapIndirectDoublePriorityQueue( final K[] refArray, final int[] a, final Comparator <? super K> c ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public ObjectHeapIndirectDoublePriorityQueue( final K[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public ObjectHeapIndirectDoublePriorityQueue( final K[] refArray, final int[] a ) {
