...
public class Object2DoubleLinkedOpenCustomHashMap <K> extends AbstractObject2DoubleSortedMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2DoubleLinkedOpenCustomHashMap( final int n, final float f, final Strategy <K> strategy ) {
 ...
 public Object2DoubleLinkedOpenCustomHashMap( final int n, final Strategy <K> strategy ) {
 ...
 private final class MapEntry implements Object2DoubleMap.Entry <K>, Map.Entry<K, Double> {
  ...
  public boolean equals( final Object o ) {
   ...
   return ( strategy.equals( (key[ index ]), ((e.getKey())) ) ) && ( (value[ index ]) == (((e.getValue()).doubleValue())) );
  }
 ...
 private class MapIterator {
  ...
  MapIterator( final K from ) {
   if ( ( strategy.equals( (key[ last ]), (from) ) ) ) {
    ...
    if ( ! Object2DoubleLinkedOpenCustomHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Object2DoubleMap.Entry <K> > implements FastSortedEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Double> e = (Map.Entry<K, Double>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2DoubleLinkedOpenCustomHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
