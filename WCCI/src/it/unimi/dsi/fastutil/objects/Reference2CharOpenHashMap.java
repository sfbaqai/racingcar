...
public class Reference2CharOpenHashMap <K> extends AbstractReference2CharMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Reference2CharOpenHashMap( final int n, final float f ) {
 ...
 public Reference2CharOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Reference2CharOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Reference2CharOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Reference2CharMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Character> e = (Map.Entry<K, Character>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Reference2CharOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
