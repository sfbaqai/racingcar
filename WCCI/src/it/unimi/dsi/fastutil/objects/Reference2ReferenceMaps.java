...
public class Reference2ReferenceMaps {
 ...
 public static class Singleton <K,V> extends Reference2ReferenceFunctions.Singleton <K,V> implements Reference2ReferenceMap <K,V>, java.io.Serializable, Cloneable {
  ...
  protected class SingletonEntry implements Reference2ReferenceMap.Entry <K,V>, Map.Entry<K,V> {
   ...
   public int hashCode() { return (System.identityHashCode(Singleton.this.key)) ^ (System.identityHashCode(Singleton.this.value)); }
  ...
  public int hashCode() { return (System.identityHashCode(key)) ^ (System.identityHashCode(value)); }
