...
public class Object2CharOpenHashMap <K> extends AbstractObject2CharMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2CharOpenHashMap( final int n, final float f ) {
 ...
 public Object2CharOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Object2CharOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Object2CharOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2CharMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Character> e = (Map.Entry<K, Character>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2CharOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
