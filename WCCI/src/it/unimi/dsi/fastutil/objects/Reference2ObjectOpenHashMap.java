...
public class Reference2ObjectOpenHashMap <K,V> extends AbstractReference2ObjectMap <K,V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Reference2ObjectOpenHashMap( final int n, final float f ) {
 ...
 public Reference2ObjectOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Reference2ObjectOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Reference2ObjectOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry <K,V> > implements FastEntrySet <K,V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, V> e = (Map.Entry<K, V>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Reference2ObjectOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
