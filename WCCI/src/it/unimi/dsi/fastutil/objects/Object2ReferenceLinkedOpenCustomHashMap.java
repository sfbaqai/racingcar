...
public class Object2ReferenceLinkedOpenCustomHashMap <K,V> extends AbstractObject2ReferenceSortedMap <K,V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2ReferenceLinkedOpenCustomHashMap( final int n, final float f, final Strategy <K> strategy ) {
 ...
 public Object2ReferenceLinkedOpenCustomHashMap( final int n, final Strategy <K> strategy ) {
 ...
 private final class MapEntry implements Object2ReferenceMap.Entry <K,V>, Map.Entry<K, V> {
  ...
  public int hashCode() {
   return ( strategy.hashCode(key[ index ]) ) ^ (System.identityHashCode(value[ index ]));
  }
 ...
 private class MapIterator {
  ...
  MapIterator( final K from ) {
   if ( ( strategy.equals( (key[ last ]), (from) ) ) ) {
    ...
    if ( ! Object2ReferenceLinkedOpenCustomHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Object2ReferenceMap.Entry <K,V> > implements FastSortedEntrySet <K,V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, V> e = (Map.Entry<K, V>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2ReferenceLinkedOpenCustomHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
