...
public class Short2LongOpenHashMap extends AbstractShort2LongMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2LongOpenHashMap( final int n, final float f ) {
 ...
 public Short2LongOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Short2LongOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Short2LongOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2LongMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Long> e = (Map.Entry<Short, Long>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2LongOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
