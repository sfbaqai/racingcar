...
public class Short2IntLinkedOpenHashMap extends AbstractShort2IntSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2IntLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Short2IntLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final short from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Short2IntLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Short2IntMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Integer> e = (Map.Entry<Short, Integer>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2IntLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
