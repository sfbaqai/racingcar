...
public class Short2LongLinkedOpenHashMap extends AbstractShort2LongSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2LongLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Short2LongLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final short from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Short2LongLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Short2LongMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Long> e = (Map.Entry<Short, Long>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2LongLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
