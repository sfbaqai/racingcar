...
public class Short2DoubleLinkedOpenHashMap extends AbstractShort2DoubleSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2DoubleLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Short2DoubleLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final short from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Short2DoubleLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Short2DoubleMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Double> e = (Map.Entry<Short, Double>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2DoubleLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
