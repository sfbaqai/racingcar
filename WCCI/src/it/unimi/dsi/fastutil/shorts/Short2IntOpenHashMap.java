...
public class Short2IntOpenHashMap extends AbstractShort2IntMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2IntOpenHashMap( final int n, final float f ) {
 ...
 public Short2IntOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Short2IntOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Short2IntOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2IntMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Integer> e = (Map.Entry<Short, Integer>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2IntOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
