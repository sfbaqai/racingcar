...
public class Short2FloatOpenHashMap extends AbstractShort2FloatMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2FloatOpenHashMap( final int n, final float f ) {
 ...
 public Short2FloatOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Short2FloatOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Short2FloatOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2FloatMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Float> e = (Map.Entry<Short, Float>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2FloatOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
