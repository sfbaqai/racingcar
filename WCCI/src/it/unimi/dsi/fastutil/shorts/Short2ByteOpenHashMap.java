...
public class Short2ByteOpenHashMap extends AbstractShort2ByteMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2ByteOpenHashMap( final int n, final float f ) {
 ...
 public Short2ByteOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Short2ByteOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Short2ByteOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2ByteMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Byte> e = (Map.Entry<Short, Byte>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2ByteOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
