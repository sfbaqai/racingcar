...
public class Short2ObjectOpenHashMap <V> extends AbstractShort2ObjectMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2ObjectOpenHashMap( final int n, final float f ) {
 ...
 public Short2ObjectOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Short2ObjectOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Short2ObjectOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2ObjectMap.Entry <V> > implements FastEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, V> e = (Map.Entry<Short, V>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2ObjectOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
