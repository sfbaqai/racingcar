...
public class Short2DoubleOpenHashMap extends AbstractShort2DoubleMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2DoubleOpenHashMap( final int n, final float f ) {
 ...
 public Short2DoubleOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Short2DoubleOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Short2DoubleOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Double> e = (Map.Entry<Short, Double>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2DoubleOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
