...
public class Long2FloatOpenHashMap extends AbstractLong2FloatMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2FloatOpenHashMap( final int n, final float f ) {
 ...
 public Long2FloatOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Long2FloatOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Long2FloatOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Long2FloatMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Float> e = (Map.Entry<Long, Float>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2FloatOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
