...
public class LongArrayIndirectDoublePriorityQueue extends LongArrayIndirectPriorityQueue implements LongIndirectDoublePriorityQueue {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public LongArrayIndirectDoublePriorityQueue( final long[] refArray, final int[] a, int size, final LongComparator c, final LongComparator d ) {
  this( refArray, 0, c, d );
  this.array = a;
  this.size = size;
 }
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public LongArrayIndirectDoublePriorityQueue( final long[] refArray, final int[] a, final LongComparator c, final LongComparator d ) {
 ...
 /** Wraps a given array in a queue using a given comparator and its opposite.
	 ...
	 */
 public LongArrayIndirectDoublePriorityQueue( final long[] refArray, final int[] a, int size, final LongComparator c ) {
  this( refArray, 0, c );
  this.array = a;
  this.size = size;
 }
 ...
 /** Wraps a given array in a queue using a given comparator and its opposite.
	 ...
	 * @param c the comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public LongArrayIndirectDoublePriorityQueue( final long[] refArray, final int[] a, final LongComparator c ) {
 ...
 /** Wraps a given array in a queue using the natural order and its opposite.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public LongArrayIndirectDoublePriorityQueue( final long[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order and its opposite.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public LongArrayIndirectDoublePriorityQueue( final long[] refArray, final int[] a ) {
 ...
 public int secondaryFront( int[] a ) {
  final long secondaryTop = refArray[ array[ findSecondaryFirst() ] ];
  int i = size, c = 0;
 ...
 /** Returns the secondary comparator of this queue.
	 ...
	 * @see #secondaryFirst()
	 */
 public LongComparator secondaryComparator() { return secondaryComparator; }
}
