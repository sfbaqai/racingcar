...
public class LongLinkedOpenHashSet extends AbstractLongSortedSet implements java.io.Serializable, Cloneable, Hash {
 ...
 public LongLinkedOpenHashSet( final int n, final float f ) {
 ...
 public LongLinkedOpenHashSet( final int n ) {
 ...
 private void writeObject(java.io.ObjectOutputStream s) throws java.io.IOException {
  ...
  while( j-- != 0 ) s.writeLong( i.nextLong() );
 }
