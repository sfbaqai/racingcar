...
public class Long2ShortLinkedOpenHashMap extends AbstractLong2ShortSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2ShortLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Long2ShortLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final long from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Long2ShortLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Long2ShortMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Short> e = (Map.Entry<Long, Short>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2ShortLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
