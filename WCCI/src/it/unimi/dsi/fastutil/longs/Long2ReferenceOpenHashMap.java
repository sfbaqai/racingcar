...
public class Long2ReferenceOpenHashMap <V> extends AbstractLong2ReferenceMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2ReferenceOpenHashMap( final int n, final float f ) {
 ...
 public Long2ReferenceOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Long2ReferenceOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Long2ReferenceOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Long2ReferenceMap.Entry <V> > implements FastEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, V> e = (Map.Entry<Long, V>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2ReferenceOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
