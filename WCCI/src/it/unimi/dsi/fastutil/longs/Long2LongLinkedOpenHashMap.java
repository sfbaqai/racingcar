...
public class Long2LongLinkedOpenHashMap extends AbstractLong2LongSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2LongLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Long2LongLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final long from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Long2LongLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Long2LongMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Long> e = (Map.Entry<Long, Long>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2LongLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
