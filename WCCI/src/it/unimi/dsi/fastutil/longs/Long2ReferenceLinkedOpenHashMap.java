...
public class Long2ReferenceLinkedOpenHashMap <V> extends AbstractLong2ReferenceSortedMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2ReferenceLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Long2ReferenceLinkedOpenHashMap( final int n ) {
 ...
 private final class MapEntry implements Long2ReferenceMap.Entry <V>, Map.Entry<Long, V> {
  ...
  public int hashCode() {
   return it.unimi.dsi.fastutil.HashCommon.long2int(key[ index ]) ^ (System.identityHashCode(value[ index ]));
  }
 ...
 private class MapIterator {
  ...
  MapIterator( final long from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Long2ReferenceLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Long2ReferenceMap.Entry <V> > implements FastSortedEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, V> e = (Map.Entry<Long, V>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2ReferenceLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
