...
public class Long2BooleanLinkedOpenHashMap extends AbstractLong2BooleanSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2BooleanLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Long2BooleanLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final long from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    prev = last;
    index = count;
   }
   else {
    if ( ! Long2BooleanLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Long2BooleanMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Boolean> e = (Map.Entry<Long, Boolean>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2BooleanLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
