...
public class Long2BooleanOpenHashMap extends AbstractLong2BooleanMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2BooleanOpenHashMap( final int n, final float f ) {
 ...
 public Long2BooleanOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Long2BooleanOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Long2BooleanOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Long2BooleanMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Boolean> e = (Map.Entry<Long, Boolean>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2BooleanOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
