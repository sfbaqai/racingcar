...
public final class LongArrays {
 ...
 /** Ensures that an array can contain the given number of entries.
	 ...
	 */
 public static final long[] ensureCapacity( final long[] array, final int length ) {
 ...
 /** Ensures that an array can contain the given number of entries, preserving just a part of the array.
	 ...
	 * entries are the same as those of <code>array</code>.
	 */
 public static final long[] ensureCapacity( final long[] array, final int length, final int preserve ) {
  if ( length > array.length ) {
   final long t[] =
 ...
 public static final long[] grow( final long[] array, final int length ) {
  if ( length > array.length ) {
 ...
 public static final long[] grow( final long[] array, final int length, final int preserve ) {
 ...
 public static final long[] trim( final long[] array, final int length ) {
 ...
 public static final long[] setLength( final long[] array, final int length ) {
  if ( length == array.length ) return array;
 ...
 public static final long[] copy( final long[] array, final int offset, final int length ) {
 ...
 public static final void fill( final long[] array, final long value ) {
  int i = array.length;
 ...
 public static final void fill( final long[] array, final int from, int to, final long value ) {
 ...
 public static final boolean equals( final long[] a1, final long a2[] ) {
  int i = a1.length;
 ...
 /** Ensures that a range given by its first (inclusive) and last (exclusive) elements fits an array.
	 ...
	 */
 public static final void ensureFromTo( final long[] a, final int from, final int to ) {
 ...
 /** Ensures that a range given by an offset and a length fits an array.
	 ...
	 */
 public static final void ensureOffsetLength( final long[] a, final int offset, final int length ) {
