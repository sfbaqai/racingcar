...
public class Long2CharOpenHashMap extends AbstractLong2CharMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2CharOpenHashMap( final int n, final float f ) {
 ...
 public Long2CharOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Long2CharOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Long2CharOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Long2CharMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Character> e = (Map.Entry<Long, Character>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2CharOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
