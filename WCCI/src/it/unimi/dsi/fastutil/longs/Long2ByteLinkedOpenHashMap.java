...
public class Long2ByteLinkedOpenHashMap extends AbstractLong2ByteSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2ByteLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Long2ByteLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final long from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Long2ByteLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Long2ByteMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Byte> e = (Map.Entry<Long, Byte>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2ByteLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
