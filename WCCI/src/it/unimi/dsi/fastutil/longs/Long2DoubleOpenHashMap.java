...
public class Long2DoubleOpenHashMap extends AbstractLong2DoubleMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2DoubleOpenHashMap( final int n, final float f ) {
 ...
 public Long2DoubleOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Long2DoubleOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Long2DoubleOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Long2DoubleMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Double> e = (Map.Entry<Long, Double>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2DoubleOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
