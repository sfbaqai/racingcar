...
public class Long2DoubleLinkedOpenHashMap extends AbstractLong2DoubleSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2DoubleLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Long2DoubleLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final long from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Long2DoubleLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Long2DoubleMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Double> e = (Map.Entry<Long, Double>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2DoubleLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
