...
public final class LongArrayList extends AbstractLongList implements RandomAccess, Cloneable, java.io.Serializable {
 ...
 public static final LongArrayList wrap( final long a[], final int length ) {
 ...
 public static final LongArrayList wrap( final long a[] ) {
 ...
 public final int indexOf( final long k ) {
 ...
 public final int lastIndexOf( final long k ) {
...
//*/
 ...
 public final void getElements( final int from, final long[] a, final int offset, final int length ) {
 ...
 public final long[] toLongArray( long a[] ) {
  if ( a == null || a.length < size ) a = new long[ size ];
  System.arraycopy( this.a, 0, a, 0, size );
  return a;
 }

 public final boolean addAll( int index, final LongCollection c ) {
 ...
 public final boolean addAll( final int index, final LongList l ) {
  if (index>=a.length) ensureIndex( index );
  final int n = l.size();
  if ( n == 0 ) return false;
  if (size+n>a.length) grow( size + n );
 ...
 public final LongListIterator listIterator( final int index ) {
  if (index>=a.length) ensureIndex( index );
 ...
 public final Object clone() {
  ...
  return c;
	 ...
	 */
 public final boolean equals( final LongArrayList l ) {
  ...
  return true;
     ...
     */
 @SuppressWarnings("unchecked")
 public final int compareTo( final LongArrayList l ) {
