...
public class Long2ShortOpenHashMap extends AbstractLong2ShortMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2ShortOpenHashMap( final int n, final float f ) {
 ...
 public Long2ShortOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Long2ShortOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Long2ShortOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Long2ShortMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Short> e = (Map.Entry<Long, Short>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2ShortOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
