...
public class Long2ByteOpenHashMap extends AbstractLong2ByteMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2ByteOpenHashMap( final int n, final float f ) {
 ...
 public Long2ByteOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Long2ByteOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Long2ByteOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Long2ByteMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Byte> e = (Map.Entry<Long, Byte>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2ByteOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
