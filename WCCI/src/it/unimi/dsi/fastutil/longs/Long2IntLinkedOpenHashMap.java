...
public class Long2IntLinkedOpenHashMap extends AbstractLong2IntSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2IntLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Long2IntLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final long from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Long2IntLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Long2IntMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Integer> e = (Map.Entry<Long, Integer>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2IntLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
