...
public final class DoubleArrayList extends AbstractDoubleList implements RandomAccess, Cloneable, java.io.Serializable {
...
private final class MyIter extends AbstractDoubleListIterator {
    ...
    public final double nextDouble() { if ( pos>=size ) throw new NoSuchElementException(); return a[ last = pos++ ]; }
    public final double previousDouble() { if ( pos<=0 ) throw new NoSuchElementException(); return a[ last = --pos ]; }
 ...
 public static final DoubleArrayList wrap( final double a[], final int length ) {
 ...
 public static final DoubleArrayList wrap( final double a[] ) {
 ...
 public final int indexOf( final double k ) {
 ...
 public final int lastIndexOf( final double k ) {
...
/*#if #keys(reference)
 ...
 public final double[] toDoubleArray( double a[] ) {
  if ( a == null || a.length < size ) a = new double[ size ];
  System.arraycopy( this.a, 0, a, 0, size );
  return a;
 }

 public final boolean addAll( int index, final DoubleCollection c ) {
  if ( index < 0 ) throw new IndexOutOfBoundsException( "Index (" + index + ") is negative" );
    if ( index > size ) throw new IndexOutOfBoundsException( "Index (" + index + ") is greater than list size (" + ( size ) + ")" );
  int n = c.size();
  if ( n == 0 ) return false;
 ...
 public final DoubleListIterator listIterator() {
  return new MyIter(0);
 }

 public final DoubleListIterator listIterator( final int index ) {
  if ( index < 0 ) throw new IndexOutOfBoundsException( "Index (" + index + ") is negative" );
    if ( index > size ) throw new IndexOutOfBoundsException( "Index (" + index + ") is greater than list size (" + ( size ) + ")" );
 ...
 public final Object clone() {
  ...
  return c;
	 ...
	 */
 public final boolean equals( final DoubleArrayList l ) {
  ...
  return true;
     ...
     */
 @SuppressWarnings("unchecked")
 public final int compareTo( final DoubleArrayList l ) {
