...
public class Double2ReferenceLinkedOpenHashMap <V> extends AbstractDouble2ReferenceSortedMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Double2ReferenceLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Double2ReferenceLinkedOpenHashMap( final int n ) {
 ...
 private final class MapEntry implements Double2ReferenceMap.Entry <V>, Map.Entry<Double, V> {
  ...
  public int hashCode() {
   return it.unimi.dsi.fastutil.HashCommon.double2int(key[ index ]) ^ (System.identityHashCode(value[ index ]));
  }
 ...
 private class MapIterator {
  ...
  MapIterator( final double from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Double2ReferenceLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Double2ReferenceMap.Entry <V> > implements FastSortedEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Double, V> e = (Map.Entry<Double, V>)o;
   final int i = findKey( ((e.getKey()).doubleValue()) );
   if ( i >= 0 ) Double2ReferenceLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
