...
public class Double2DoubleOpenHashMap extends AbstractDouble2DoubleMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Double2DoubleOpenHashMap( final int n, final float f ) {
 ...
 public Double2DoubleOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Double2DoubleOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Double2DoubleOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Double2DoubleMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Double, Double> e = (Map.Entry<Double, Double>)o;
   final int i = findKey( ((e.getKey()).doubleValue()) );
   if ( i >= 0 ) Double2DoubleOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
