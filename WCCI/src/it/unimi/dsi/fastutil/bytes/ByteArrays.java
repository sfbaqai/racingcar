...
public final class ByteArrays {
 ...
 /** Ensures that an array can contain the given number of entries.
	 ...
	 */
 public static final byte[] ensureCapacity( final byte[] array, final int length ) {
 ...
 /** Ensures that an array can contain the given number of entries, preserving just a part of the array.
	 ...
	 * entries are the same as those of <code>array</code>.
	 */
 public static final byte[] ensureCapacity( final byte[] array, final int length, final int preserve ) {
  if ( length > array.length ) {
   final byte t[] =
 ...
 public static final byte[] grow( final byte[] array, final int length ) {
  if ( length > array.length ) {
 ...
 public static final byte[] grow( final byte[] array, final int length, final int preserve ) {
 ...
 public static final byte[] trim( final byte[] array, final int length ) {
 ...
 public static final byte[] setLength( final byte[] array, final int length ) {
  if ( length == array.length ) return array;
 ...
 public static final byte[] copy( final byte[] array, final int offset, final int length ) {
 ...
 public static final void fill( final byte[] array, final byte value ) {
  int i = array.length;
 ...
 public static final void fill( final byte[] array, final int from, int to, final byte value ) {
 ...
 public static final boolean equals( final byte[] a1, final byte a2[] ) {
  int i = a1.length;
 ...
 /** Ensures that a range given by its first (inclusive) and last (exclusive) elements fits an array.
	 ...
	 */
 public static final void ensureFromTo( final byte[] a, final int from, final int to ) {
 ...
 /** Ensures that a range given by an offset and a length fits an array.
	 ...
	 */
 public static final void ensureOffsetLength( final byte[] a, final int offset, final int length ) {
