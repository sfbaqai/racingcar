...
// Lexer
//-----------------------------------------------------------------------------
header {package net.sourceforge.jFuzzyLogic.fcl;}
...
membership_function : singleton | piece_wise_linear | gauss | trian | trape | sigm | gbell ;
singleton : atom;
...
defuzzification_method : METHOD^ COLON! (COG|COGS|COA|LM|RM|MM) SEMICOLON!;
