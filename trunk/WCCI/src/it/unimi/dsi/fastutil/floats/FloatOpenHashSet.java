...
public class FloatOpenHashSet extends AbstractFloatSet implements java.io.Serializable, Cloneable, Hash {
 ...
 public FloatOpenHashSet( final int n, final float f ) {
 ...
 public FloatOpenHashSet( final int n ) {
 ...
 private class SetIterator extends AbstractFloatIterator {
  ...
  {
   final byte state[] = FloatOpenHashSet.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < FloatOpenHashSet.this.state.length;
  }
 ...
 private void writeObject(java.io.ObjectOutputStream s) throws java.io.IOException {
  ...
  while( j-- != 0 ) s.writeFloat( i.nextFloat() );
 }
