...
public class Float2ReferenceOpenHashMap <V> extends AbstractFloat2ReferenceMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2ReferenceOpenHashMap( final int n, final float f ) {
 ...
 public Float2ReferenceOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Float2ReferenceOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Float2ReferenceOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Float2ReferenceMap.Entry <V> > implements FastEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, V> e = (Map.Entry<Float, V>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2ReferenceOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
