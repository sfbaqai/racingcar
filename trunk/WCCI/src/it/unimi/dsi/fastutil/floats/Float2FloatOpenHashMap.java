...
public class Float2FloatOpenHashMap extends AbstractFloat2FloatMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2FloatOpenHashMap( final int n, final float f ) {
 ...
 public Float2FloatOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Float2FloatOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Float2FloatOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Float2FloatMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Float> e = (Map.Entry<Float, Float>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2FloatOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
