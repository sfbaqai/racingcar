...
public class Float2IntLinkedOpenHashMap extends AbstractFloat2IntSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2IntLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Float2IntLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final float from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Float2IntLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Float2IntMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Integer> e = (Map.Entry<Float, Integer>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2IntLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
