...
public class Float2BooleanLinkedOpenHashMap extends AbstractFloat2BooleanSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2BooleanLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Float2BooleanLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final float from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Float2BooleanLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Float2BooleanMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Boolean> e = (Map.Entry<Float, Boolean>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2BooleanLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
