...
public class Float2CharOpenHashMap extends AbstractFloat2CharMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2CharOpenHashMap( final int n, final float f ) {
 ...
 public Float2CharOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Float2CharOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Float2CharOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Float2CharMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Character> e = (Map.Entry<Float, Character>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2CharOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
