...
public class FloatHeapSesquiIndirectDoublePriorityQueue extends FloatHeapSemiIndirectPriorityQueue implements FloatIndirectDoublePriorityQueue {
 ...
 /** Creates a new empty queue with a given capacity.
	 ...
	 */
 public FloatHeapSesquiIndirectDoublePriorityQueue( float[] refArray, int capacity, FloatComparator c, FloatComparator d ) {
 ...
 public FloatHeapSesquiIndirectDoublePriorityQueue( float[] refArray, int capacity, FloatComparator c ) {
  super( refArray, capacity, c );
 ...
 /** Creates a new empty queue with a given capacity and natural order as primary comparator.
	 ...
	 * @param capacity the initial capacity of this queue.
	 */
 public FloatHeapSesquiIndirectDoublePriorityQueue( float[] refArray, int capacity ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public FloatHeapSesquiIndirectDoublePriorityQueue( float[] refArray, FloatComparator c, FloatComparator d ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public FloatHeapSesquiIndirectDoublePriorityQueue( float[] refArray, FloatComparator c ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array and natural order as primary comparator.
	 ...
	 * @param refArray the reference array.
	 */
 public FloatHeapSesquiIndirectDoublePriorityQueue( float[] refArray ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public FloatHeapSesquiIndirectDoublePriorityQueue( final float[] refArray, final int[] a, int size, final FloatComparator c, final FloatComparator d ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public FloatHeapSesquiIndirectDoublePriorityQueue( final float[] refArray, final int[] a, final FloatComparator c, final FloatComparator d ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 */
 @SuppressWarnings("unchecked")
 public FloatHeapSesquiIndirectDoublePriorityQueue( final float[] refArray, final int[] a, int size, final FloatComparator c ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public FloatHeapSesquiIndirectDoublePriorityQueue( final float[] refArray, final int[] a, final FloatComparator c ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public FloatHeapSesquiIndirectDoublePriorityQueue( final float[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public FloatHeapSesquiIndirectDoublePriorityQueue( final float[] refArray, final int[] a ) {
