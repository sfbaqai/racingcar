...
public class Float2LongOpenHashMap extends AbstractFloat2LongMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2LongOpenHashMap( final int n, final float f ) {
 ...
 public Float2LongOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Float2LongOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Float2LongOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Float2LongMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Long> e = (Map.Entry<Float, Long>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2LongOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
