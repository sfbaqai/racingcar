...
public class Float2CharLinkedOpenHashMap extends AbstractFloat2CharSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2CharLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Float2CharLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final float from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Float2CharLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Float2CharMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, Character> e = (Map.Entry<Float, Character>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2CharLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
