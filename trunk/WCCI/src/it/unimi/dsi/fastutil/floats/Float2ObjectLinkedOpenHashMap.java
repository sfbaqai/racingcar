...
public class Float2ObjectLinkedOpenHashMap <V> extends AbstractFloat2ObjectSortedMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float2ObjectLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Float2ObjectLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final float from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Float2ObjectLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Float2ObjectMap.Entry <V> > implements FastSortedEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Float, V> e = (Map.Entry<Float, V>)o;
   final int i = findKey( ((e.getKey()).floatValue()) );
   if ( i >= 0 ) Float2ObjectLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
