...
public final class FloatArrayList extends AbstractFloatList implements RandomAccess, Cloneable, java.io.Serializable {
 ...
 public static final FloatArrayList wrap( final float a[], final int length ) {
 ...
 public static final FloatArrayList wrap( final float a[] ) {
 ...
 public final int indexOf( final float k ) {
 ...
 public final int lastIndexOf( final float k ) {
...
//*/
 ...
 public final void getElements( final int from, final float[] a, final int offset, final int length ) {
 ...
 public final float[] toFloatArray( float a[] ) {
  if ( a == null || a.length < size ) a = new float[ size ];
  System.arraycopy( this.a, 0, a, 0, size );
  return a;
 }

 public final boolean addAll( int index, final FloatCollection c ) {
 ...
 public final boolean addAll( final int index, final FloatList l ) {
  if (index>=a.length) ensureIndex( index );
  final int n = l.size();
  if ( n == 0 ) return false;
  if (size+n>a.length) grow( size + n );
 ...
 public final FloatListIterator listIterator( final int index ) {
  if (index>=a.length) ensureIndex( index );
 ...
 public final Object clone() {
  ...
  return c;
	 ...
	 */
 public final boolean equals( final FloatArrayList l ) {
  ...
  return true;
     ...
     */
 @SuppressWarnings("unchecked")
 public final int compareTo( final FloatArrayList l ) {
