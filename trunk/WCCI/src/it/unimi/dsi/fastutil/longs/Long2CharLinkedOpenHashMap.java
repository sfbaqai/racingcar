...
public class Long2CharLinkedOpenHashMap extends AbstractLong2CharSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2CharLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Long2CharLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final long from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Long2CharLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Long2CharMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Character> e = (Map.Entry<Long, Character>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2CharLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
