...
public class LongHeapSesquiIndirectDoublePriorityQueue extends LongHeapSemiIndirectPriorityQueue implements LongIndirectDoublePriorityQueue {
 ...
 /** Creates a new empty queue with a given capacity.
	 ...
	 */
 public LongHeapSesquiIndirectDoublePriorityQueue( long[] refArray, int capacity, LongComparator c, LongComparator d ) {
 ...
 public LongHeapSesquiIndirectDoublePriorityQueue( long[] refArray, int capacity, LongComparator c ) {
  super( refArray, capacity, c );
 ...
 /** Creates a new empty queue with a given capacity and natural order as primary comparator.
	 ...
	 * @param capacity the initial capacity of this queue.
	 */
 public LongHeapSesquiIndirectDoublePriorityQueue( long[] refArray, int capacity ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public LongHeapSesquiIndirectDoublePriorityQueue( long[] refArray, LongComparator c, LongComparator d ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public LongHeapSesquiIndirectDoublePriorityQueue( long[] refArray, LongComparator c ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array and natural order as primary comparator.
	 ...
	 * @param refArray the reference array.
	 */
 public LongHeapSesquiIndirectDoublePriorityQueue( long[] refArray ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public LongHeapSesquiIndirectDoublePriorityQueue( final long[] refArray, final int[] a, int size, final LongComparator c, final LongComparator d ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public LongHeapSesquiIndirectDoublePriorityQueue( final long[] refArray, final int[] a, final LongComparator c, final LongComparator d ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 */
 @SuppressWarnings("unchecked")
 public LongHeapSesquiIndirectDoublePriorityQueue( final long[] refArray, final int[] a, int size, final LongComparator c ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public LongHeapSesquiIndirectDoublePriorityQueue( final long[] refArray, final int[] a, final LongComparator c ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public LongHeapSesquiIndirectDoublePriorityQueue( final long[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public LongHeapSesquiIndirectDoublePriorityQueue( final long[] refArray, final int[] a ) {
