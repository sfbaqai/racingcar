...
public class Long2ReferenceMaps {
 ...
 public static class Singleton <V> extends Long2ReferenceFunctions.Singleton <V> implements Long2ReferenceMap <V>, java.io.Serializable, Cloneable {
  ...
  protected class SingletonEntry implements Long2ReferenceMap.Entry <V>, Map.Entry<Long,V> {
   ...
   public int hashCode() { return it.unimi.dsi.fastutil.HashCommon.long2int(Singleton.this.key) ^ (System.identityHashCode(Singleton.this.value)); }
  ...
  public int hashCode() { return it.unimi.dsi.fastutil.HashCommon.long2int(key) ^ (System.identityHashCode(value)); }
