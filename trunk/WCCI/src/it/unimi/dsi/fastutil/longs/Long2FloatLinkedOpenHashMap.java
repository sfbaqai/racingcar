...
public class Long2FloatLinkedOpenHashMap extends AbstractLong2FloatSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2FloatLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Long2FloatLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final long from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Long2FloatLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Long2FloatMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Float> e = (Map.Entry<Long, Float>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2FloatLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
