...
public class Long2LongOpenHashMap extends AbstractLong2LongMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long2LongOpenHashMap( final int n, final float f ) {
 ...
 public Long2LongOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Long2LongOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Long2LongOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Long2LongMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Long, Long> e = (Map.Entry<Long, Long>)o;
   final int i = findKey( ((e.getKey()).longValue()) );
   if ( i >= 0 ) Long2LongOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
