...
public class Object2DoubleOpenCustomHashMap <K> extends AbstractObject2DoubleMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2DoubleOpenCustomHashMap( final int n, final float f, final Strategy <K> strategy ) {
 ...
 public Object2DoubleOpenCustomHashMap( final int n, final Strategy <K> strategy ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Object2DoubleOpenCustomHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Object2DoubleOpenCustomHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2DoubleMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Double> e = (Map.Entry<K, Double>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2DoubleOpenCustomHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
