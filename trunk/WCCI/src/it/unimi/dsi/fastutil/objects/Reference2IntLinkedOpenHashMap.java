...
public class Reference2IntLinkedOpenHashMap <K> extends AbstractReference2IntSortedMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Reference2IntLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Reference2IntLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final K from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Reference2IntLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Reference2IntMap.Entry <K> > implements FastSortedEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Integer> e = (Map.Entry<K, Integer>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Reference2IntLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
