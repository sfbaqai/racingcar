...
public class Object2ReferenceOpenCustomHashMap <K,V> extends AbstractObject2ReferenceMap <K,V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2ReferenceOpenCustomHashMap( final int n, final float f, final Strategy <K> strategy ) {
 ...
 public Object2ReferenceOpenCustomHashMap( final int n, final Strategy <K> strategy ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Object2ReferenceOpenCustomHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Object2ReferenceOpenCustomHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2ReferenceMap.Entry <K,V> > implements FastEntrySet <K,V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, V> e = (Map.Entry<K, V>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2ReferenceOpenCustomHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
