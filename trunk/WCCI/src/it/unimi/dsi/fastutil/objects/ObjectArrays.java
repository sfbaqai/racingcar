...
public final class ObjectArrays {
 ...
 private static final <K> K[] newArray( final K[] prototype, final int length ) {
 ...
 /** Ensures that an array can contain the given number of entries.
	 ...
	 */
 public static final <K> K[] ensureCapacity( final K[] array, final int length ) {
 ...
 /** Ensures that an array can contain the given number of entries, preserving just a part of the array.
	 ...
	 * entries are the same as those of <code>array</code>.
	 */
 public static final <K> K[] ensureCapacity( final K[] array, final int length, final int preserve ) {
  if ( length > array.length ) {
   final K t[] =
 ...
 public static final <K> K[] grow( final K[] array, final int length ) {
  if ( length > array.length ) {
 ...
 public static final <K> K[] grow( final K[] array, final int length, final int preserve ) {
 ...
 public static final <K> K[] trim( final K[] array, final int length ) {
 ...
 public static final <K> K[] setLength( final K[] array, final int length ) {
  if ( length == array.length ) return array;
 ...
 public static final <K> K[] copy( final K[] array, final int offset, final int length ) {
  if ( offset < 0 ) throw new ArrayIndexOutOfBoundsException( "Offset (" + offset + ") is negative" );
  if ( length < 0 ) throw new IllegalArgumentException( "Length (" + length + ") is negative" );
  if ( offset + length > array.length ) throw new ArrayIndexOutOfBoundsException( "Last index (" + ( offset + length ) + ") is greater than array length (" + array.length + ")" );
  final K[] a =
 ...
 public static final <K> K[] copy( final K[] array ) {
  return array.clone();
 }
 ...
 public static final <K> void fill( final K[] array, final K value ) {
  int i = array.length;
 ...
 public static final <K> void fill( final K[] array, final int from, int to, final K value ) {
  if ( from < 0 ) throw new ArrayIndexOutOfBoundsException( "Start index (" + from + ") is negative" );
  if ( from > to ) throw new IllegalArgumentException( "Start index (" + from + ") is greater than end index (" + to + ")" );
  if ( to > array.length ) throw new ArrayIndexOutOfBoundsException( "End index (" + to + ") is greater than array length (" + array.length + ")" );
 ...
 public static final <K> boolean equals( final K[] a1, final K a2[] ) {
  int i = a1.length;
 ...
 /** Ensures that a range given by its first (inclusive) and last (exclusive) elements fits an array.
	 ...
	 */
 public static final <K> void ensureFromTo( final K[] a, final int from, final int to ) {
  if ( from < 0 ) throw new ArrayIndexOutOfBoundsException( "Start index (" + from + ") is negative" );
  if ( from > to ) throw new IllegalArgumentException( "Start index (" + from + ") is greater than end index (" + to + ")" );
 ...
 /** Ensures that a range given by an offset and a length fits an array.
	 ...
	 */
 public static final <K> void ensureOffsetLength( final K[] a, final int offset, final int length ) {
  if ( offset < 0 ) throw new ArrayIndexOutOfBoundsException( "Offset (" + offset + ") is negative" );
  if ( length < 0 ) throw new IllegalArgumentException( "Length (" + length + ") is negative" );
 ...
 private static final class ArrayHashStrategy <K> implements Hash.Strategy<K[]>, java.io.Serializable {
  ...
  public final int hashCode( final K[] o ) {
   return java.util.Arrays.hashCode( o );
  }

  public final boolean equals( final K[] a, final K[] b ) {
   int i = a.length;
   if (i != b.length ) return false;
   while( i-- != 0 ) if (! ( (a[ i ]) == null ? (b[ i ]) == null : (a[ i ]).equals(b[ i ]) ) ) return false;
   return true;
  }
 }
