...
public class Reference2IntOpenHashMap <K> extends AbstractReference2IntMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Reference2IntOpenHashMap( final int n, final float f ) {
 ...
 public Reference2IntOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Reference2IntOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Reference2IntOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Reference2IntMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Integer> e = (Map.Entry<K, Integer>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Reference2IntOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
