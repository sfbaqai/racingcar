...
public class Reference2CharLinkedOpenHashMap <K> extends AbstractReference2CharSortedMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Reference2CharLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Reference2CharLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final K from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Reference2CharLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Reference2CharMap.Entry <K> > implements FastSortedEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Character> e = (Map.Entry<K, Character>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Reference2CharLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
