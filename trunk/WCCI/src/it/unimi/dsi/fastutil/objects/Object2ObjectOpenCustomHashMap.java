...
public class Object2ObjectOpenCustomHashMap <K,V> extends AbstractObject2ObjectMap <K,V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2ObjectOpenCustomHashMap( final int n, final float f, final Strategy <K> strategy ) {
 ...
 public Object2ObjectOpenCustomHashMap( final int n, final Strategy <K> strategy ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Object2ObjectOpenCustomHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Object2ObjectOpenCustomHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2ObjectMap.Entry <K,V> > implements FastEntrySet <K,V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, V> e = (Map.Entry<K, V>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2ObjectOpenCustomHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
