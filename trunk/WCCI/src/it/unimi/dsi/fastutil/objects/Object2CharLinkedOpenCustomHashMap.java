...
public class Object2CharLinkedOpenCustomHashMap <K> extends AbstractObject2CharSortedMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2CharLinkedOpenCustomHashMap( final int n, final float f, final Strategy <K> strategy ) {
 ...
 public Object2CharLinkedOpenCustomHashMap( final int n, final Strategy <K> strategy ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final K from ) {
   if ( ( strategy.equals( (key[ last ]), (from) ) ) ) {
    ...
    if ( ! Object2CharLinkedOpenCustomHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Object2CharMap.Entry <K> > implements FastSortedEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Character> e = (Map.Entry<K, Character>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2CharLinkedOpenCustomHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
