...
public class Object2DoubleOpenHashMap <K> extends AbstractObject2DoubleMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2DoubleOpenHashMap( final int n, final float f ) {
 ...
 public Object2DoubleOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Object2DoubleOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Object2DoubleOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2DoubleMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Double> e = (Map.Entry<K, Double>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2DoubleOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
