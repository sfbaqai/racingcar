...
public class ObjectArrayIndirectDoublePriorityQueue <K> extends ObjectArrayIndirectPriorityQueue <K> implements IndirectDoublePriorityQueue <K> {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public ObjectArrayIndirectDoublePriorityQueue( final K[] refArray, final int[] a, int size, final Comparator <? super K> c, final Comparator <? super K> d ) {
  this( refArray, 0, c, d );
  this.array = a;
  this.size = size;
 }
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public ObjectArrayIndirectDoublePriorityQueue( final K[] refArray, final int[] a, final Comparator <? super K> c, final Comparator <? super K> d ) {
 ...
 /** Wraps a given array in a queue using a given comparator and its opposite.
	 ...
	 */
 public ObjectArrayIndirectDoublePriorityQueue( final K[] refArray, final int[] a, int size, final Comparator <? super K> c ) {
  this( refArray, 0, c );
  this.array = a;
  this.size = size;
 }
 ...
 /** Wraps a given array in a queue using a given comparator and its opposite.
	 ...
	 * @param c the comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public ObjectArrayIndirectDoublePriorityQueue( final K[] refArray, final int[] a, final Comparator <? super K> c ) {
 ...
 /** Wraps a given array in a queue using the natural order and its opposite.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public ObjectArrayIndirectDoublePriorityQueue( final K[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order and its opposite.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public ObjectArrayIndirectDoublePriorityQueue( final K[] refArray, final int[] a ) {
 ...
 private int findSecondaryFirst() {
  ...
  if ( secondaryComparator == null ) while( i-- != 0 ) { if ( ( ((Comparable<K>)(refArray[ array[ i ] ])).compareTo(first) < 0 ) ) first = refArray[ array[ firstIndex = i ] ]; }
 ...
 private int findSecondaryLast() {
  ...
  if ( secondaryComparator == null ) while( i-- != 0 ) { if ( ( ((Comparable<K>)(last)).compareTo(refArray[ array[ i ] ]) < 0 ) ) last = refArray[ array[ lastIndex = i ] ]; }
 ...
 public int secondaryFront( int[] a ) {
  final K secondaryTop = refArray[ array[ findSecondaryFirst() ] ];
  int i = size, c = 0;
  while( i-- != 0 ) if ( ( (secondaryTop).equals(refArray[ array[ i ] ]) ) ) a[ c++ ] = array[ i ];
  return c;
 }
 ...
 /** Returns the secondary comparator of this queue.
	 ...
	 * @see #secondaryFirst()
	 */
 public Comparator <? super K> secondaryComparator() { return secondaryComparator; }
}
