...
public class Object2ReferenceLinkedOpenHashMap <K,V> extends AbstractObject2ReferenceSortedMap <K,V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2ReferenceLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Object2ReferenceLinkedOpenHashMap( final int n ) {
 ...
 private final class MapEntry implements Object2ReferenceMap.Entry <K,V>, Map.Entry<K, V> {
  ...
  public int hashCode() {
   return ( (key[ index ]) == null ? 0 : (key[ index ]).hashCode() ) ^ (System.identityHashCode(value[ index ]));
  }
 ...
 private class MapIterator {
  ...
  MapIterator( final K from ) {
   if ( ( (key[ last ]) == null ? (from) == null : (key[ last ]).equals(from) ) ) {
    ...
    if ( ! Object2ReferenceLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
    do e = nextEntry(); while( ! ( (key[ e ]) == null ? (from) == null : (key[ e ]).equals(from) ) );
    curr = -1;
   }
  }
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Object2ReferenceMap.Entry <K,V> > implements FastSortedEntrySet <K,V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, V> e = (Map.Entry<K, V>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2ReferenceLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
