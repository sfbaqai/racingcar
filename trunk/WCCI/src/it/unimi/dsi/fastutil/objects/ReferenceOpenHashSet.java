...
public class ReferenceOpenHashSet <K> extends AbstractReferenceSet <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public ReferenceOpenHashSet( final int n, final float f ) {
 ...
 public ReferenceOpenHashSet( final int n ) {
 ...
 private class SetIterator extends AbstractObjectIterator <K> {
  ...
  {
   final byte state[] = ReferenceOpenHashSet.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < ReferenceOpenHashSet.this.state.length;
  }
