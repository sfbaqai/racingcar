...
public class Object2IntLinkedOpenHashMap <K> extends AbstractObject2IntSortedMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  MapIterator( final K from ) {
   if ( ( (key[ last ]) == null ? (from) == null : (key[ last ]).equals(from) ) ) {
    ...
    if ( ! Object2IntLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Object2IntMap.Entry <K> > implements FastSortedEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Integer> e = (Map.Entry<K, Integer>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2IntLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
