...
public class Object2DoubleLinkedOpenHashMap <K> extends AbstractObject2DoubleSortedMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2DoubleLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Object2DoubleLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final K from ) {
   if ( ( (key[ last ]) == null ? (from) == null : (key[ last ]).equals(from) ) ) {
    ...
    if ( ! Object2DoubleLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Object2DoubleMap.Entry <K> > implements FastSortedEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Double> e = (Map.Entry<K, Double>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2DoubleLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
