...
public class Short2ReferenceLinkedOpenHashMap <V> extends AbstractShort2ReferenceSortedMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2ReferenceLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Short2ReferenceLinkedOpenHashMap( final int n ) {
 ...
 private final class MapEntry implements Short2ReferenceMap.Entry <V>, Map.Entry<Short, V> {
  ...
  public int hashCode() {
   return (key[ index ]) ^ (System.identityHashCode(value[ index ]));
  }
 ...
 private class MapIterator {
  ...
  MapIterator( final short from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Short2ReferenceLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Short2ReferenceMap.Entry <V> > implements FastSortedEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, V> e = (Map.Entry<Short, V>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2ReferenceLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
