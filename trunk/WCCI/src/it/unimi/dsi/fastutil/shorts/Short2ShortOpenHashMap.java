...
public class Short2ShortOpenHashMap extends AbstractShort2ShortMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2ShortOpenHashMap( final int n, final float f ) {
 ...
 public Short2ShortOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Short2ShortOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Short2ShortOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2ShortMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Short> e = (Map.Entry<Short, Short>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2ShortOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
