...
public class Short2CharLinkedOpenHashMap extends AbstractShort2CharSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2CharLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Short2CharLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final short from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Short2CharLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Short2CharMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Character> e = (Map.Entry<Short, Character>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2CharLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
