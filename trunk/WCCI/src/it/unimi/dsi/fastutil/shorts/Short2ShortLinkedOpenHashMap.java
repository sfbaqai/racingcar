...
public class Short2ShortLinkedOpenHashMap extends AbstractShort2ShortSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2ShortLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Short2ShortLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final short from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Short2ShortLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Short2ShortMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Short> e = (Map.Entry<Short, Short>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2ShortLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
