...
public class ShortOpenHashSet extends AbstractShortSet implements java.io.Serializable, Cloneable, Hash {
 ...
 public ShortOpenHashSet( final int n, final float f ) {
 ...
 public ShortOpenHashSet( final int n ) {
 ...
 private class SetIterator extends AbstractShortIterator {
  ...
  {
   final byte state[] = ShortOpenHashSet.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < ShortOpenHashSet.this.state.length;
  }
