...
public class Short2ObjectLinkedOpenHashMap <V> extends AbstractShort2ObjectSortedMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2ObjectLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Short2ObjectLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final short from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Short2ObjectLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Short2ObjectMap.Entry <V> > implements FastSortedEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, V> e = (Map.Entry<Short, V>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2ObjectLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
