...
public class Short2FloatLinkedOpenHashMap extends AbstractShort2FloatSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2FloatLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Short2FloatLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final short from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Short2FloatLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Short2FloatMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Float> e = (Map.Entry<Short, Float>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2FloatLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
