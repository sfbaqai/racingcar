...
public class Short2ByteLinkedOpenHashMap extends AbstractShort2ByteSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2ByteLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Short2ByteLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final short from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Short2ByteLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 public Byte get(final Short ok) {
  ...
  return i < 0 ? (null) : (Byte)(Byte.valueOf(value[i]));
 }
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Short2ByteMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean contains( final Object o ) {
   ...
   return i >= 0 && ( (value[ i ]) == (((e.getValue()).byteValue())) );
  }
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Byte> e = (Map.Entry<Short, Byte>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2ByteLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
 ...
 protected void rehash( final int newP ) {
  ...
  final byte value[] = this.value, newValue[] = new byte[newN];
