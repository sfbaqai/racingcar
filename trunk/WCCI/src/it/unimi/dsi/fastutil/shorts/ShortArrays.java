...
public final class ShortArrays {
 ...
 /** Ensures that an array can contain the given number of entries.
	 ...
	 */
 public static final short[] ensureCapacity( final short[] array, final int length ) {
 ...
 /** Ensures that an array can contain the given number of entries, preserving just a part of the array.
	 ...
	 * entries are the same as those of <code>array</code>.
	 */
 public static final short[] ensureCapacity( final short[] array, final int length, final int preserve ) {
  if ( length > array.length ) {
   final short t[] =
 ...
 public static final short[] grow( final short[] array, final int length ) {
  if ( length > array.length ) {
 ...
 public static final short[] grow( final short[] array, final int length, final int preserve ) {
 ...
 public static final short[] trim( final short[] array, final int length ) {
 ...
 public static final short[] setLength( final short[] array, final int length ) {
  if ( length == array.length ) return array;
 ...
 public static final short[] copy( final short[] array, final int offset, final int length ) {
 ...
 public static final void fill( final short[] array, final short value ) {
  int i = array.length;
 ...
 public static final void fill( final short[] array, final int from, int to, final short value ) {
 ...
 public static final boolean equals( final short[] a1, final short a2[] ) {
  int i = a1.length;
 ...
 /** Ensures that a range given by its first (inclusive) and last (exclusive) elements fits an array.
	 ...
	 */
 public static final void ensureFromTo( final short[] a, final int from, final int to ) {
 ...
 /** Ensures that a range given by an offset and a length fits an array.
	 ...
	 */
 public static final void ensureOffsetLength( final short[] a, final int offset, final int length ) {
