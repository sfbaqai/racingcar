...
public class Short2ReferenceOpenHashMap <V> extends AbstractShort2ReferenceMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2ReferenceOpenHashMap( final int n, final float f ) {
 ...
 public Short2ReferenceOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Short2ReferenceOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Short2ReferenceOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2ReferenceMap.Entry <V> > implements FastEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, V> e = (Map.Entry<Short, V>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2ReferenceOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
