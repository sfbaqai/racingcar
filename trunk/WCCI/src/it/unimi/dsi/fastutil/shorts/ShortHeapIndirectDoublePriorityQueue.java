...
public class ShortHeapIndirectDoublePriorityQueue extends ShortHeapIndirectPriorityQueue implements ShortIndirectDoublePriorityQueue {
 ...
 /** Creates a new empty queue with a given capacity.
	 ...
	 */
 public ShortHeapIndirectDoublePriorityQueue( short[] refArray, int capacity, ShortComparator c, ShortComparator d ) {
 ...
 public ShortHeapIndirectDoublePriorityQueue( short[] refArray, int capacity, ShortComparator c ) {
  super( refArray, capacity, c );
 ...
 /** Creates a new empty queue with a given capacity and natural order as primary comparator.
	 ...
	 * @param capacity the initial capacity of this queue.
	 */
 public ShortHeapIndirectDoublePriorityQueue( short[] refArray, int capacity ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public ShortHeapIndirectDoublePriorityQueue( short[] refArray, ShortComparator c, ShortComparator d ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public ShortHeapIndirectDoublePriorityQueue( short[] refArray, ShortComparator c ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array and natural order as primary comparator.
	 ...
	 * @param refArray the reference array.
	 */
 public ShortHeapIndirectDoublePriorityQueue( short[] refArray ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public ShortHeapIndirectDoublePriorityQueue( final short[] refArray, final int[] a, int size, final ShortComparator c, final ShortComparator d ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public ShortHeapIndirectDoublePriorityQueue( final short[] refArray, final int[] a, final ShortComparator c, final ShortComparator d ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 */
 @SuppressWarnings("unchecked")
 public ShortHeapIndirectDoublePriorityQueue( final short[] refArray, final int[] a, int size, final ShortComparator c ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public ShortHeapIndirectDoublePriorityQueue( final short[] refArray, final int[] a, final ShortComparator c ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public ShortHeapIndirectDoublePriorityQueue( final short[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public ShortHeapIndirectDoublePriorityQueue( final short[] refArray, final int[] a ) {
