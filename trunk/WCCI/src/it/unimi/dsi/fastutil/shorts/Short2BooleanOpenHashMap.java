...
public class Short2BooleanOpenHashMap extends AbstractShort2BooleanMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2BooleanOpenHashMap( final int n, final float f ) {
 ...
 public Short2BooleanOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Short2BooleanOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Short2BooleanOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2BooleanMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Boolean> e = (Map.Entry<Short, Boolean>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2BooleanOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
