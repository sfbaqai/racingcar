...
public class Short2BooleanLinkedOpenHashMap extends AbstractShort2BooleanSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short2BooleanLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Short2BooleanLinkedOpenHashMap( final int n ) {
 ...
 public boolean put(final short k, final boolean v) {
  ...
  if (i < 0) {
   final boolean oldValue = value[-i-1];
   value[-i-1] = v;
   return oldValue;
  }
 ...
 private class MapIterator {
  ...
  MapIterator( final short from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    prev = last;
    index = count;
   }
   else {
    if ( ! Short2BooleanLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 public Boolean get(final Short ok) {
  ...
  return i < 0 ? (null) : (Boolean)(Boolean.valueOf(value[i]));
 }
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Short2BooleanMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean contains( final Object o ) {
   ...
   return i >= 0 && ( (value[ i ]) == (((e.getValue()).booleanValue())) );
  }
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Short, Boolean> e = (Map.Entry<Short, Boolean>)o;
   final int i = findKey( ((e.getKey()).shortValue()) );
   if ( i >= 0 ) Short2BooleanLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
 ...
 protected void rehash( final int newP ) {
  ...
  final boolean value[] = this.value, newValue[] = new boolean[newN];
