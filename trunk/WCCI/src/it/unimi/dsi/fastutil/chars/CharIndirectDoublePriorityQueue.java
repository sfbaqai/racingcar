...
public interface CharIndirectDoublePriorityQueue extends CharIndirectPriorityQueue, IndirectDoublePriorityQueue<Character> {
	 ...
	 */
 CharComparator secondaryComparator();
}
