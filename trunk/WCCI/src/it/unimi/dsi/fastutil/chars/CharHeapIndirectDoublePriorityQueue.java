...
public class CharHeapIndirectDoublePriorityQueue extends CharHeapIndirectPriorityQueue implements CharIndirectDoublePriorityQueue {
 ...
 /** Creates a new empty queue with a given capacity.
	 ...
	 */
 public CharHeapIndirectDoublePriorityQueue( char[] refArray, int capacity, CharComparator c, CharComparator d ) {
 ...
 public CharHeapIndirectDoublePriorityQueue( char[] refArray, int capacity, CharComparator c ) {
  super( refArray, capacity, c );
 ...
 /** Creates a new empty queue with a given capacity and natural order as primary comparator.
	 ...
	 * @param capacity the initial capacity of this queue.
	 */
 public CharHeapIndirectDoublePriorityQueue( char[] refArray, int capacity ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public CharHeapIndirectDoublePriorityQueue( char[] refArray, CharComparator c, CharComparator d ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public CharHeapIndirectDoublePriorityQueue( char[] refArray, CharComparator c ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array and natural order as primary comparator.
	 ...
	 * @param refArray the reference array.
	 */
 public CharHeapIndirectDoublePriorityQueue( char[] refArray ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public CharHeapIndirectDoublePriorityQueue( final char[] refArray, final int[] a, int size, final CharComparator c, final CharComparator d ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public CharHeapIndirectDoublePriorityQueue( final char[] refArray, final int[] a, final CharComparator c, final CharComparator d ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 */
 @SuppressWarnings("unchecked")
 public CharHeapIndirectDoublePriorityQueue( final char[] refArray, final int[] a, int size, final CharComparator c ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public CharHeapIndirectDoublePriorityQueue( final char[] refArray, final int[] a, final CharComparator c ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public CharHeapIndirectDoublePriorityQueue( final char[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public CharHeapIndirectDoublePriorityQueue( final char[] refArray, final int[] a ) {
