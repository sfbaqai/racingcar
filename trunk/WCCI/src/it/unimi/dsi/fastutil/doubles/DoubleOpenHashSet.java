...
public class DoubleOpenHashSet extends AbstractDoubleSet implements java.io.Serializable, Cloneable, Hash {
 ...
 public DoubleOpenHashSet( final int n, final float f ) {
 ...
 public DoubleOpenHashSet( final int n ) {
 ...
 private class SetIterator extends AbstractDoubleIterator {
  ...
  {
   final byte state[] = DoubleOpenHashSet.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < DoubleOpenHashSet.this.state.length;
  }
 ...
 private void writeObject(java.io.ObjectOutputStream s) throws java.io.IOException {
  ...
  while( j-- != 0 ) s.writeDouble( i.nextDouble() );
 }
