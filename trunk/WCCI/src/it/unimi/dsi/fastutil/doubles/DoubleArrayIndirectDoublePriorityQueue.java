...
public class DoubleArrayIndirectDoublePriorityQueue extends DoubleArrayIndirectPriorityQueue implements DoubleIndirectDoublePriorityQueue {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public DoubleArrayIndirectDoublePriorityQueue( final double[] refArray, final int[] a, int size, final DoubleComparator c, final DoubleComparator d ) {
  this( refArray, 0, c, d );
  this.array = a;
  this.size = size;
 }
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public DoubleArrayIndirectDoublePriorityQueue( final double[] refArray, final int[] a, final DoubleComparator c, final DoubleComparator d ) {
 ...
 /** Wraps a given array in a queue using a given comparator and its opposite.
	 ...
	 */
 public DoubleArrayIndirectDoublePriorityQueue( final double[] refArray, final int[] a, int size, final DoubleComparator c ) {
  this( refArray, 0, c );
  this.array = a;
  this.size = size;
 }
 ...
 /** Wraps a given array in a queue using a given comparator and its opposite.
	 ...
	 * @param c the comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public DoubleArrayIndirectDoublePriorityQueue( final double[] refArray, final int[] a, final DoubleComparator c ) {
 ...
 /** Wraps a given array in a queue using the natural order and its opposite.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public DoubleArrayIndirectDoublePriorityQueue( final double[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order and its opposite.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public DoubleArrayIndirectDoublePriorityQueue( final double[] refArray, final int[] a ) {
 ...
 public int secondaryFront( int[] a ) {
  final double secondaryTop = refArray[ array[ findSecondaryFirst() ] ];
  int i = size, c = 0;
 ...
 /** Returns the secondary comparator of this queue.
	 ...
	 * @see #secondaryFirst()
	 */
 public DoubleComparator secondaryComparator() { return secondaryComparator; }
}
