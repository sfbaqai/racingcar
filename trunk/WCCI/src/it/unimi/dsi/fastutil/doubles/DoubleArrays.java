...
public final class DoubleArrays {
 ...
 /** Ensures that an array can contain the given number of entries.
	 ...
	 */
 public static final double[] ensureCapacity( final double[] array, final int length ) {
 ...
 /** Ensures that an array can contain the given number of entries, preserving just a part of the array.
	 ...
	 * entries are the same as those of <code>array</code>.
	 */
 public static final double[] ensureCapacity( final double[] array, final int length, final int preserve ) {
  if ( length > array.length ) {
   final double t[] =
 ...
 public static final double[] grow( final double[] array, final int length ) {
  if ( length > array.length ) {
 ...
 public static final double[] grow( final double[] array, final int length, final int preserve ) {
 ...
 public static final double[] trim( final double[] array, final int length ) {
 ...
 public static final double[] setLength( final double[] array, final int length ) {
  if ( length == array.length ) return array;
 ...
 public static final double[] copy( final double[] array, final int offset, final int length ) {
 ...
 public static final void fill( final double[] array, final double value ) {
  int i = array.length;
 ...
 public static final void fill( final double[] array, final int from, int to, final double value ) {
 ...
 public static final boolean equals( final double[] a1, final double a2[] ) {
  int i = a1.length;
 ...
 /** Ensures that a range given by its first (inclusive) and last (exclusive) elements fits an array.
	 ...
	 */
 public static final void ensureFromTo( final double[] a, final int from, final int to ) {
  if ( from < 0 ) throw new ArrayIndexOutOfBoundsException( "Start index (" + from + ") is negative" );
  if ( from > to ) throw new IllegalArgumentException( "Start index (" + from + ") is greater than end index (" + to + ")" );
 ...
 /** Ensures that a range given by an offset and a length fits an array.
	 ...
	 */
 public static final void ensureOffsetLength( final double[] a, final int offset, final int length ) {
  if ( offset < 0 ) throw new ArrayIndexOutOfBoundsException( "Offset (" + offset + ") is negative" );
  if ( length < 0 ) throw new IllegalArgumentException( "Length (" + length + ") is negative" );
 ...
 private static final class ArrayHashStrategy implements Hash.Strategy<double[]>, java.io.Serializable {
  ...
  public final int hashCode( final double[] o ) {
   return java.util.Arrays.hashCode( o );
  }

  public final boolean equals( final double[] a, final double[] b ) {
   int i = a.length;
