...
public class DoubleHeapIndirectDoublePriorityQueue extends DoubleHeapIndirectPriorityQueue implements DoubleIndirectDoublePriorityQueue {
 ...
 /** Creates a new empty queue with a given capacity.
	 ...
	 */
 public DoubleHeapIndirectDoublePriorityQueue( double[] refArray, int capacity, DoubleComparator c, DoubleComparator d ) {
 ...
 public DoubleHeapIndirectDoublePriorityQueue( double[] refArray, int capacity, DoubleComparator c ) {
  super( refArray, capacity, c );
 ...
 /** Creates a new empty queue with a given capacity and natural order as primary comparator.
	 ...
	 * @param capacity the initial capacity of this queue.
	 */
 public DoubleHeapIndirectDoublePriorityQueue( double[] refArray, int capacity ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public DoubleHeapIndirectDoublePriorityQueue( double[] refArray, DoubleComparator c, DoubleComparator d ) {
 ...
 /** Creates a new empty queue with capacity equal to the length of the reference array.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public DoubleHeapIndirectDoublePriorityQueue( double[] refArray, DoubleComparator c ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public DoubleHeapIndirectDoublePriorityQueue( final double[] refArray, final int[] a, int size, final DoubleComparator c, final DoubleComparator d ) {
 ...
 /** Wraps a given array in a queue using the given comparators.
	 ...
	 * @param d the secondary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public DoubleHeapIndirectDoublePriorityQueue( final double[] refArray, final int[] a, final DoubleComparator c, final DoubleComparator d ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 */
 @SuppressWarnings("unchecked")
 public DoubleHeapIndirectDoublePriorityQueue( final double[] refArray, final int[] a, int size, final DoubleComparator c ) {
 ...
 /** Wraps a given array in a queue using a given comparator.
	 ...
	 * @param c the primary comparator used in this queue, or <code>null</code> for the natural order.
	 */
 public DoubleHeapIndirectDoublePriorityQueue( final double[] refArray, final int[] a, final DoubleComparator c ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param size the number of elements to be included in the queue.
	 */
 public DoubleHeapIndirectDoublePriorityQueue( final double[] refArray, final int[] a, int size ) {
 ...
 /** Wraps a given array in a queue using the natural order.
	 ...
	 * @param a an array of indices into <code>refArray</code>.
	 */
 public DoubleHeapIndirectDoublePriorityQueue( final double[] refArray, final int[] a ) {
