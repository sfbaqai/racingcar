...
public class Double2ReferenceOpenHashMap <V> extends AbstractDouble2ReferenceMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Double2ReferenceOpenHashMap( final int n, final float f ) {
 ...
 public Double2ReferenceOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Double2ReferenceOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Double2ReferenceOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Double2ReferenceMap.Entry <V> > implements FastEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Double, V> e = (Map.Entry<Double, V>)o;
   final int i = findKey( ((e.getKey()).doubleValue()) );
   if ( i >= 0 ) Double2ReferenceOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
