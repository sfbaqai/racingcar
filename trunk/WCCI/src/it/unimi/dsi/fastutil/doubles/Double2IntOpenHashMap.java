...
public class Double2IntOpenHashMap extends AbstractDouble2IntMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Double2IntOpenHashMap( final int n, final float f ) {
 ...
 public Double2IntOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Double2IntOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Double2IntOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Double2IntMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Double, Integer> e = (Map.Entry<Double, Integer>)o;
   final int i = findKey( ((e.getKey()).doubleValue()) );
   if ( i >= 0 ) Double2IntOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
