...
public class Double2IntLinkedOpenHashMap extends AbstractDouble2IntSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Double2IntLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Double2IntLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final double from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Double2IntLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Double2IntMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Double, Integer> e = (Map.Entry<Double, Integer>)o;
   final int i = findKey( ((e.getKey()).doubleValue()) );
   if ( i >= 0 ) Double2IntLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
