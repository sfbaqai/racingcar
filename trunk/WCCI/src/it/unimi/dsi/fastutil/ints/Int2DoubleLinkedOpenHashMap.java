...
public class Int2DoubleLinkedOpenHashMap extends AbstractInt2DoubleSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Int2DoubleLinkedOpenHashMap( final int n, final float f ) {
 ...
 public Int2DoubleLinkedOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  MapIterator( final int from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Int2DoubleLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Int2DoubleMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Integer, Double> e = (Map.Entry<Integer, Double>)o;
   final int i = findKey( ((e.getKey()).intValue()) );
   if ( i >= 0 ) Int2DoubleLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
