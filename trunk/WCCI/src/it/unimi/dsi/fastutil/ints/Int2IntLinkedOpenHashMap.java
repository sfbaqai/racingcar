...
public class Int2IntLinkedOpenHashMap extends AbstractInt2IntSortedMap implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  MapIterator( final int from ) {
   if ( ( (key[ last ]) == (from) ) ) {
    ...
    if ( ! Int2IntLinkedOpenHashMap.this.containsKey( from ) ) throw new IllegalArgumentException( "The key " + from + " does not belong to this set." );
    next = first;
    int e;
 ...
 private final class MapEntrySet extends AbstractObjectSortedSet<Int2IntMap.Entry > implements FastSortedEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Integer, Integer> e = (Map.Entry<Integer, Integer>)o;
   final int i = findKey( ((e.getKey()).intValue()) );
   if ( i >= 0 ) Int2IntLinkedOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
