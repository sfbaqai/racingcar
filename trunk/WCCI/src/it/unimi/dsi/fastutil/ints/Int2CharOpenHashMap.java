...
public class Int2CharOpenHashMap extends AbstractInt2CharMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Int2CharOpenHashMap( final int n, final float f ) {
 ...
 public Int2CharOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  {
   final byte state[] = Int2CharOpenHashMap.this.state;
  ...
  public boolean hasNext() {
   return c != 0 && pos < Int2CharOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Int2CharMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Integer, Character> e = (Map.Entry<Integer, Character>)o;
   final int i = findKey( ((e.getKey()).intValue()) );
   if ( i >= 0 ) Int2CharOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
